...
export default class $Ref {
   ...
   */
  get(path, options: $RefParserOptions) {
   ...
   * @returns {Pointer}
   */
  resolve(path: string, options: $RefParserOptions, friendlyPath?: string) {
   ...
   * @returns {boolean}
   */
  static isAllowed$Ref(value: any, options?: $RefParserOptions) {
    if ($Ref.is$Ref(value)) {
