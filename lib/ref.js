...
function $Ref() {
  /**
   * The URL of the referenced file.
   * This url is relative to the url of the main JSON schema file.
   *
   * This url does NOT contain document fragments (JSON pointers). It always references an ENTIRE file.
  ...
  /**
   * Indicates the type of {@link $Ref#url} (e.g. "file", "http", etc.)
   * @type {?string}
   */
 ...
 * @returns {boolean}
 */
$Ref.prototype.exists = function(url, options) {
  try {
 ...
 * @returns {Pointer}
 */
$Ref.prototype.resolve = function(url, options) {
 ...
 */
$Ref.prototype.set = function(url, value) {
  var pointer = new Pointer(this, url);
