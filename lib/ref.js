...
/**
 * Resolves the given JSON Reference within the {@link Schema}.
 *
 * @param {Schema} schema - The Schema object in which the JSON Reference is resolved
 * @param {string} url - An absolute URL, including a JSON Pointer in the hash
 * @param {$RefParserOptions} options
 * @returns {Pointer}
 */
$Ref.resolve = function resolve(schema, url, options) {
  var fileUrl = URL.stripHash(url);
  var file = schema.files(fileUrl);
