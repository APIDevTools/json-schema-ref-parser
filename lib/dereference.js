 ...
 *
 * @param {{$ref: string}} $refObject - The JSON Reference to resolve
 ...
 * @returns {{value: object, circular: boolean}}
 */
function dereference$Ref ($refObject, path, pathFromRoot, parents, processedObjects, dereferencedCache, $refs, options) {
  ...
  let dereferencedValue = $Ref.dereference($refObject, pointer.value);
