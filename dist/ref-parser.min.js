...
"use strict";function $RefParserOptions(e){this.parse={json:parseJSON,yaml:parseYAML,text:parseText,binary:parseBinary},this.resolve={file:readFile,http:readHttp},this.dereference={circular:!0},merge(e,this)}function merge(e,r){if(e)for(var a=Object.keys(e),s=0;s<a.length;s++){var t=a[s],i=e[t],p=r[t];i&&"object"==typeof i&&!Array.isArray(i)?r[t]=merge(i,p):r[t]=i}}var parseJSON=require("./parse/json"),parseYAML=require("./parse/yaml"),parseText=require("./parse/text"),parseBinary=require("./parse/binary"),readFile=require("./read/file"),readHttp=require("./read/http");module.exports=$RefParserOptions;

},{"./parse/binary":5,"./parse/json":7,"./parse/text":8,"./parse/yaml":9,"./read/file":11,"./read/http":12}],5:[function(require,module,exports){
"use strict";function parseBinary(e,r,o){return new Promise(function(r){r(e)})}var Promise=require("../util/promise");module.exports=parseBinary,module.exports.order=4,module.exports.empty=!0,module.exports.ext=[".jpeg",".jpg",".gif",".png",".bmp",".ico"];

},{"../util/promise":18}],6:[function(require,module,exports){
(function (Buffer){
"use strict";function parse(e,t,n){return new Promise(function(r,s){var i,o,u,a=util.path.extname(t);util.runInOrder(n.parse,function(e,n){n.ext.some(function(r){return r===a||r instanceof RegExp&&r.test(t)?(i=n,o=e,u=n.empty,!0):void 0})}),i?(util.debug('Parsing "%s" as %s',t,o),i(e,t,n).then(function(e){!u&&isEmpty(e)?s(ono.syntax('Error parsing "%s" as %s. \nParsed value is empty',t,o)):r(e)},function(e){s(ono.syntax(e,'Error parsing "%s" as %s',t,o))})):s(ono.syntax('Unable to parse "%s"',t))})}function isEmpty(e){return!e||"object"==typeof e&&0===Object.keys(e).length||"string"==typeof e&&0===e.trim().length||Buffer.isBuffer(e)&&0===e.length}var util=require("../util"),Promise=require("../util/promise"),ono=require("ono");module.exports=parse;

}).call(this,{"isBuffer":require("../../node_modules/is-buffer/index.js")})

},{"../../node_modules/is-buffer/index.js":38,"../util":17,"../util/promise":18,"ono":71}],7:[function(require,module,exports){
"use strict";function parseJSON(e,r,o){return new Promise(function(r){r(JSON.parse(e.toString()))})}var Promise=require("../util/promise");module.exports=parseJSON,module.exports.order=1,module.exports.empty=!0,module.exports.ext=[".json"];

},{"../util/promise":18}],8:[function(require,module,exports){
"use strict";function parseText(e,t,s){return new Promise(function(t){t(e.toString(s.parse.text.encoding))})}var Promise=require("../util/promise");module.exports=parseText,module.exports.order=3,module.exports.empty=!0,module.exports.encoding="utf8",module.exports.ext=[".txt",".htm",".html",".md",".xml",".js",".css",".scss",".less",".min",".map",".svg"];

},{"../util/promise":18}],9:[function(require,module,exports){
"use strict";function parseYAML(e,r,o){return new Promise(function(r){r(YAML.parse(e.toString()))})}var Promise=require("../util/promise"),YAML=require("../util/yaml");module.exports=parseYAML,module.exports.order=2,module.exports.empty=!0,module.exports.ext=[".yaml",".yml",".json"];
...
},{"./_stream_duplex":80,"_process":74,"buffer":23,"core-util-is":27,"events":32,"inherits":37,"isarray":39,"process-nextick-args":73,"stream":89,"string_decoder/":94,"util":21}],83:[function(require,module,exports){
...
},{"./_stream_duplex":80,"buffer":23,"core-util-is":27,"events":32,"inherits":37,"process-nextick-args":73,"stream":89,"util-deprecate":97}],85:[function(require,module,exports){
