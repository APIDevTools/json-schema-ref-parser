...
"use strict";function $RefParser(){this.schema=null,this.$refs=new $Refs,this._basePath=""}var Promise=require("./promise"),Options=require("./options"),$Refs=require("./refs"),read=require("./read"),resolve=require("./resolve"),bundle=require("./bundle"),dereference=require("./dereference"),util=require("./util"),url=require("url"),ono=require("ono"),_cloneDeep=require("lodash/lang/cloneDeep"),_isFunction=require("lodash/lang/isFunction"),_isObject=require("lodash/lang/isObject"),_isPlainObject=require("lodash/lang/isPlainObject"),_isString=require("lodash/lang/isString");module.exports=$RefParser,module.falsy&&require("./_preamble"),$RefParser.parse=function(e,r,n){return(new $RefParser).parse(e,r,n)},$RefParser.prototype.parse=function(e,r,n){if(_isFunction(r)&&(n=r,r=void 0),e&&_isObject(e))return this.schema=_cloneDeep(e),this._basePath="",util.doCallback(n,null,this.schema),Promise.resolve(this.schema);if(!e||!_isString(e)){var t=ono("Expected a file path, URL, or object. Got %s",e);return util.doCallback(n,t,e),Promise.reject(t)}r=new Options(r);var i=this;return e=url.resolve(util.cwd(),e),this._basePath=util.stripHash(e),read(e,this,r).then(function(e){if(e.value&&_isPlainObject(e.value))return i.schema=e.value,util.doCallback(n,null,i.schema),i.schema;throw ono.syntax('"%s" is not a valid JSON Schema',i._basePath)})["catch"](function(e){return util.doCallback(n,e),Promise.reject(e)})},$RefParser.resolve=function(e,r,n){return(new $RefParser).resolve(e,r,n)},$RefParser.prototype.resolve=function(e,r,n){_isFunction(r)&&(n=r,r=void 0),r=new Options(r);var t=this;return this.parse(e,r).then(function(){return resolve(t,r)}).then(function(){return util.doCallback(n,null,t.$refs),t.$refs})["catch"](function(e){return util.doCallback(n,e,t.$refs),Promise.reject(e)})},$RefParser.bundle=function(e,r,n){return(new $RefParser).bundle(e,r,n)},$RefParser.prototype.bundle=function(e,r,n){_isFunction(r)&&(n=r,r=void 0),r=new Options(r);var t=this;return this.resolve(e,r).then(function(){return bundle(t,r),util.doCallback(n,null,t.schema),t.schema})["catch"](function(e){return util.doCallback(n,e,t.schema),Promise.reject(e)})},$RefParser.dereference=function(e,r,n){return(new $RefParser).dereference(e,r,n)},$RefParser.prototype.dereference=function(e,r,n){_isFunction(r)&&(n=r,r=void 0),r=new Options(r);var t=this;return this.resolve(e,r).then(function(){return dereference(t,r),util.doCallback(n,null,t.schema),t.schema})["catch"](function(e){return util.doCallback(n,e,t.schema),Promise.reject(e)})};
...
},{"./_stream_duplex":116,"_process":110,"buffer":102,"core-util-is":121,"events":106,"inherits":108,"isarray":109,"process-nextick-args":122,"stream":128,"string_decoder/":138,"util":101}],119:[function(require,module,exports){
...
},{"./_stream_duplex":116,"buffer":102,"core-util-is":121,"events":106,"inherits":108,"process-nextick-args":122,"stream":128,"util-deprecate":123}],121:[function(require,module,exports){
(function (Buffer){
...
},{"./lib/_stream_duplex.js":116,"./lib/_stream_passthrough.js":117,"./lib/_stream_readable.js":118,"./lib/_stream_transform.js":119,"./lib/_stream_writable.js":120,"stream":128}],126:[function(require,module,exports){
