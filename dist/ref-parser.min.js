...
"use strict";function dereference(e,r){util.debug("Dereferencing $ref pointers in %s",e._base),crawl(e.schema,e._base,[],e.$refs,r)}function crawl(e,r,a,l,i){(_isObject(e)||_isArray(e))&&(a.push(e),_forEach(e,function(s,n){var o=new PathOrUrl(r);if(o.hash+="/"+n,$Ref.isAllowed(s,i)){util.debug('Dereferencing $ref pointer "%s" at %s',s.$ref,o);var t=r.resolve(s.$ref,{allowFileHash:!0}),c=new PathOrUrl(t,{allowFileHash:!0}),f=l._resolve(c,i);e[n]=s=f.value,-1===a.indexOf(s)&&crawl(f.value,f.pathOrUrl,a,l,i)}else-1===a.indexOf(s)&&crawl(s,o,a,l,i)}),a.pop())}var PathOrUrl=require("./path-or-url"),$Ref=require("./ref"),util=require("./util"),_forEach=require("lodash/collection/forEach"),_isArray=require("lodash/lang/isArray"),_isObject=require("lodash/lang/isObject");module.exports=dereference;
 ...
 * @license MIT
 */
"use strict";function $RefParser(){this.schema=null,this.$refs=new $Refs,this._base=null}var Promise=require("./promise"),Options=require("./options"),PathOrUrl=require("./path-or-url"),$Refs=require("./refs"),read=require("./read"),resolve=require("./resolve"),dereference=require("./dereference"),util=require("./util"),_cloneDeep=require("lodash/lang/cloneDeep"),_isFunction=require("lodash/lang/isFunction"),_isObject=require("lodash/lang/isObject"),_isPlainObject=require("lodash/lang/isPlainObject"),_isString=require("lodash/lang/isString");module.exports=$RefParser,$RefParser.parse=function(e,r,t){return(new $RefParser).parse(e,r,t)},$RefParser.prototype.parse=function(e,r,t){if(_isFunction(r)&&(t=r,r=void 0),e&&_isObject(e))return this.schema=_cloneDeep(e),this._base=PathOrUrl.cwd(),util.doCallback(t,null,this.schema),Promise.resolve(this.schema);if(!e||!_isString(e)){var i=util.newError("Expected a file path, URL, or object. Got %s",e);return util.doCallback(t,i,e),Promise.reject(i)}r=new Options(r);var n=this;return this._base=new PathOrUrl(e,{allowFileHash:!0}),read(this._base,this,r).then(function(e){if(e.value&&_isPlainObject(e.value))return n.schema=e.value,util.doCallback(t,null,n.schema),n.schema;throw util.newError(SyntaxError,'"%s" is not a valid JSON Schema',n._base)})["catch"](function(e){return util.doCallback(t,e),Promise.reject(e)})},$RefParser.resolve=function(e,r,t){return(new $RefParser).resolve(e,r,t)},$RefParser.prototype.resolve=function(e,r,t){_isFunction(r)&&(t=r,r=void 0),r=new Options(r);var i=this;return this.parse(e,r).then(function(){return resolve(i,r)}).then(function(){return util.doCallback(t,null,i.$refs),i.$refs})["catch"](function(e){return util.doCallback(t,e,i.$refs),Promise.reject(e)})},$RefParser.dereference=function(e,r,t){return(new $RefParser).dereference(e,r,t)},$RefParser.prototype.dereference=function(e,r,t){_isFunction(r)&&(t=r,r=void 0),r=new Options(r);var i=this;return this.resolve(e,r).then(function(){return dereference(i,r),util.doCallback(t,null,i.schema),i.schema})["catch"](function(e){return util.doCallback(t,e,i.schema),Promise.reject(e)})};
...
"use strict";function Options(e){this.allow={json:!0,yaml:!0,empty:!0,unknown:!0},this.$refs={internal:!0,external:!0},this.cache={fs:60,http:300,https:300},_merge(this,e)}var _merge=require("lodash/object/merge");module.exports=Options;

},{"lodash/object/merge":116}],4:[function(require,module,exports){
"use strict";function parse(r,e,t){var i;try{t.allow.yaml?(util.debug("Parsing YAML file: %s",e),i=yaml.safeLoad(r.toString()),util.debug("    Parsed successfully")):t.allow.json?(util.debug("Parsing JSON file: %s",e),i=JSON.parse(r.toString()),util.debug("    Parsed successfully")):i=r}catch(l){var s=e.ext.toLowerCase();if(!t.allow.unknown||-1!==[".json",".yaml",".yml"].indexOf(s))throw util.newError(SyntaxError,l,'Error parsing "%s"',e);util.debug("    Unknown file format. Not parsed."),i=r}var a=_isEmpty(i)||0===i.length||_isString(i)&&0===i.trim().length;if(a&&!t.allow.empty)throw util.newError(SyntaxError,'Error parsing "%s". \nParsed value is empty',e);return i}var yaml=require("js-yaml"),util=require("./util"),_isEmpty=require("lodash/lang/isEmpty"),_isString=require("lodash/lang/isString");module.exports=parse;

},{"./util":11,"js-yaml":16,"lodash/lang/isEmpty":105,"lodash/lang/isString":111}],5:[function(require,module,exports){
(function (process){
"use strict";function PathOrUrl(r,t){if(this.isUrl=!1,this.isFile=!1,this.href="",this.protocol="",this.slashes=!1,this.auth="",this.host="",this.hostname="",this.port="",this.path="",this.pathname="",this.root="",this.dir="",this.base="",this.name="",this.ext="",this.search="",this.query="",this.hash="",_isString(r))this.parse(r,t);else if(r instanceof url.Url)this.parse(r.format(),t);else{if(!(r instanceof PathOrUrl))throw util.newError("Expected a file path or URL, but got %s",r);copy(r,this)}}function parseUrl(r,t){var e={};return t.pathname&&parseFile(e,t.pathname),r.isUrl=!0,r.isFile=!1,r.href=t.href||"",r.protocol=t.protocol||"",r.slashes=t.slashes||!1,r.auth=t.auth||"",r.host=t.host||"",r.hostname=t.hostname||"",r.port=t.port||"",r.path=t.path||"",r.pathname=t.pathname||"",r.root=e.root||"",r.dir=e.dir||"",r.base=e.base||"",r.name=e.name||"",r.ext=e.ext||"",r.search=t.search||"",r.query=t.query||"",r.hash=t.hash||"",r}function parseFile(r,t,e){var a="",s="",h=t;if(e=e||{},e.allowFileHash){var o=t.indexOf("#");o>=0&&(a=t.substr(o),t=t.substr(0,o))}if(e.allowFileQuery){var i=t.lastIndexOf("?");i>=0&&(s=t.substr(i+1),t=t.substr(0,i))}var n,l,p,u;return"/"===t.substr(-1)||t.substr(-1)===path.sep?(n=t.substr(0,t.length-1),l=p=u=""):(n=path.dirname(t),l=path.basename(t),u=path.extname(t),p=path.basename(t,u)),r.isUrl=!1,r.isFile=!0,r.href=h||"",r.protocol="",r.slashes=!1,r.auth="",r.host="",r.hostname="",r.port="",r.path=t+(s?"?"+s:""),r.pathname=t,r.root=getRoot(t),r.dir=n,r.base=l,r.name=p,r.ext=u,r.search=s?"?"+s:"",r.query=s,r.hash=a,r}function parseRelativeFile(r,t,e,a){e=parseFile({},e,a);var s;return s=e.pathname?path.resolve(t.dir,e.pathname)+e.search+e.hash:e.search?t.pathname+e.search+e.hash:t.pathname+t.search+(e.hash||t.hash),parseFile(r,s,a)}function copy(r,t){return t.isUrl=r.isUrl,t.isFile=r.isFile,t.href=r.href,t.protocol=r.protocol,t.slashes=r.slashes,t.auth=r.auth,t.host=r.host,t.hostname=r.hostname,t.port=r.port,t.path=r.path,t.pathname=r.pathname,t.root=r.root,t.dir=r.dir,t.base=r.base,t.name=r.name,t.ext=r.ext,t.search=r.search,t.query=r.query,t.hash=r.hash,t}function getRoot(r){if("/"===r[0])return"/";var t=r.substr(1,2);return!isWindows||":\\"!==t&&":/"!==t?"":r.substr(0,3)}var path=require("path"),url=require("url"),util=require("./util"),_isString=require("lodash/lang/isString"),isWindows=/^win/.test(process.platform),protocolPattern=/^[a-z0-9.+-]{2,}:/i;module.exports=PathOrUrl,PathOrUrl.dirname=function(r,t){return new PathOrUrl(r,t).dirname()},PathOrUrl.prototype.dirname=function(){return this.dir},PathOrUrl.basename=function(r,t,e){return _isString(t)&&(e=t,t=void 0),new PathOrUrl(r,t).basename(e)},PathOrUrl.prototype.basename=function(r){return r&&this.ext===r?this.name:this.base},PathOrUrl.extname=function(r,t){return new PathOrUrl(r,t)},PathOrUrl.prototype.extname=function(){return this.ext},PathOrUrl.resolve=function(r,t,e){return new PathOrUrl(r,e).resolve(t,e)},PathOrUrl.prototype.resolve=function(r,t){var e;if(r instanceof PathOrUrl)return r.format();if(r instanceof url.Url&&(r=r.format()),util.debug('Resolving path "%s", relative to "%s"',r,this),this.isUrl||protocolPattern.test(r))e=url.resolve(this.format(),r);else{var a=parseRelativeFile({},this,r,t);e=PathOrUrl.prototype.format.call(a)}return util.debug("    Resolved to %s",e),e},PathOrUrl.format=function(r,t){return new PathOrUrl(r,t).format()},PathOrUrl.prototype.format=function(){var r=copy(this,{});if(r.dir||r.base||r.name||r.ext){var t=r.isFile?path.sep:"/";r.base=r.base||r.name+r.ext||"",r.base[0]===t&&(r.base=r.base.substr(1)),r.dir=r.dir||"",r.dir.substr(-1)===t?r.pathname=r.dir+r.base:r.pathname=r.dir+t+r.base}return r.isUrl?url.format(r):(r.query?r.search="?"+r.query:r.search&&"?"!==r.search[0]&&(r.search="?"+r.search),r.hash&&"#"!==r.hash[0]&&(r.hash="#"+r.hash),path.normalize(r.pathname)+r.search+r.hash)},PathOrUrl.prototype.toString=PathOrUrl.prototype.format,PathOrUrl.toUrl=function(r,t){return new PathOrUrl(r,t).toUrl()},PathOrUrl.prototype.toUrl=function(){return url.parse(this.toUrlString())},PathOrUrl.toUrlString=function(r,t){return new PathOrUrl(r,t).toUrlString()},PathOrUrl.prototype.toUrlString=function(){if(this.isUrl)return url.format(this);var r=this.pathname;return"/"!==path.sep&&(r=r.replace(new RegExp("\\"+path.sep,"g"),"/")),url.format({protocol:"file:",slashes:!0,pathname:r,search:this.search,hash:this.hash})},PathOrUrl.cwd=function(){var r;if(process.browser){var t=window.location.href,e=t.lastIndexOf("/");r=t.substr(0,e+1)}else r=process.cwd()+path.sep;return new PathOrUrl(r)},PathOrUrl.parse=function(r,t){return new PathOrUrl(r,t)},PathOrUrl.prototype.parse=function(r,t){process.browser?parseUrl(this,url.parse(url.resolve(window.location.href,r))):getRoot(r)?parseFile(this,r,t):protocolPattern.test(r)?parseUrl(this,url.parse(r)):parseRelativeFile(this,PathOrUrl.cwd(),r,t)};
...
(function (process){
"use strict";function read(r,e,t){try{r.hash="",r=new PathOrUrl(r.format()),util.debug("Reading %s",r);var n=e.$refs._get$Ref(r);return n&&!n.isExpired()?(util.debug("    cached from %s",n.type),n.cached=!0,Promise.resolve(n)):(n=new $Ref(r),e.$refs._set$Ref(n),read$Ref(n,e,t))}catch(o){return Promise.reject(o)}}function read$Ref(r,e,t){var n="",o=null;try{return $refTypes.some(function(i,a){return n=i.name,util.debug("    trying %s",n),o=i.handler.call(e,r.pathOrUrl,t)}),o?(r.type=n,o.then(function(e){var n=parse(e,r.pathOrUrl,t);return r.setValue(n,t),r.cached=!1,r})):Promise.reject(util.newError(SyntaxError,'Unable to resolve $ref pointer "%s"',r.pathOrUrl))}catch(i){return Promise.reject(i)}}function readFile(r,e){if(!process.browser&&r.isFile&&e.$refs.external){var t=r.format();return new Promise(function(r,e){try{util.debug("Reading file: %s",t),fs.readFile(t,function(n,o){n?e(util.newError(n,'Error opening file "%s"',t)):r(o)})}catch(n){e(util.newError(n,'Error opening file "%s"',t))}})}}function httpDownload(r,e){return e.$refs.external&&"http:"===r.protocol?download(http,r,e):void 0}function httpsDownload(r,e){return e.$refs.external&&"https:"===r.protocol?download(https,r,e):void 0}function download(r,e,t){return new Promise(function(n,o){function i(r){var i;r.on("data",function(r){i=i?i.concat(r):r}),r.on("end",function(){r.statusCode>=400?o(util.newError("GET %s \nHTTP ERROR %d \n%s",e,r.statusCode,i)):204!==r.statusCode&&i&&i.length||t.allow.empty?n(i):o(util.newError("GET %s \nHTTP 204: No Content",e))}),r.on("error",function(r){o(util.newError(r,'Error downloading file "%s"',e))})}try{util.debug("Downloading file: %s",e);var a=r.get({hostname:e.hostname,port:e.port,path:e.path,auth:e.auth},i);_isFunction(a.setTimeout)&&a.setTimeout(5e3),a.on("timeout",function(){a.abort()}),a.on("error",function(r){o(util.newError(r,'Error downloading file "%s"',e))})}catch(u){o(util.newError(u,'Error downloading file "%s"',e))}})}var fs=require("fs"),http=require("http"),https=require("https"),parse=require("./parse"),util=require("./util"),$Ref=require("./ref"),PathOrUrl=require("./path-or-url"),Promise=require("./promise"),_isFunction=require("lodash/lang/isFunction");module.exports=read;var $refTypes=[{name:"http",handler:httpDownload},{name:"https",handler:httpsDownload},{name:"fs",handler:readFile}];
...
"use strict";function $Ref(e){this.$refs=null,this.pathOrUrl=e,this.value=void 0,this.type="pending",this.expires=void 0}function parse(e){e="#"===e[0]?e.substr(1):e,e=e.split("/");for(var r=0;r<e.length;r++)e[r]=e[r].replace(/~1/g,"/").replace(/~0/g,"~");if(""!==e[0])throw util.newError(SyntaxError,'Invalid $ref pointer "%s". Pointers must begin with "#/"',e);return e.slice(1)}function resolve(e,r,t){if($Ref.isAllowed(e.value,t)){var i=e.pathOrUrl.resolve(e.value.$ref,{allowFileHash:!0}),s=new PathOrUrl(i,{allowFileHash:!0});s.href!==e.pathOrUrl.href&&(e.pathOrUrl=s,e.value=r.$refs.get(e.pathOrUrl))}return e}var util=require("./util"),PathOrUrl=require("./path-or-url"),_isObject=require("lodash/lang/isObject"),_isNumber=require("lodash/lang/isNumber"),_isString=require("lodash/lang/isString");module.exports=$Ref,$Ref.prototype.setValue=function(e,r){this.value=e;var t=r.cache[this.type];if(_isNumber(t)){var i=Date.now()+1e3*t;this.expires=new Date(i)}},$Ref.prototype.isExpired=function(){return this.expires&&this.expires<=new Date},$Ref.prototype.expire=function(){this.expires=new Date},$Ref.prototype.exists=function(e){try{return this.get(e),!0}catch(r){return!1}},$Ref.prototype.resolve=function(e,r){for(var t=parse(e.hash),i={pathOrUrl:e,value:this.value},s=0;s<t.length;s++){if(resolve(i,this,r),!(t[s]in i.value))throw util.newError(SyntaxError,'Error resolving $ref pointer "%s". \n"%s" not found.',e,e.hash);i.value=i.value[t[s]]}return resolve(i,this,r)},$Ref.prototype.get=function(e,r){return this.resolve(e,r).value},$Ref.prototype.set=function(e,r,t){try{for(var i=parse(e.hash),s={pathOrUrl:e,value:this.value},l=0;l<i.length-1;l++)resolve(s,this,t),i[l]in s.value?s.value=s.value[i[l]]:s.value=s.value[i[l]]={};resolve(s,this,t),s.value[i[i.length-1]]=r}catch(n){throw util.newError(SyntaxError,n,'Error resolving $ref pointer "%s". \n"%s" not found.',e,e.hash)}},$Ref.isAllowed=function(e,r){if(e&&_isObject(e)&&_isString(e.$ref))if("#"===e.$ref[0]){if(r.$refs.internal)return!0}else if(r.$refs.external)return!0};
...
"use strict";function $Refs(){this._$refs={}}var PathOrUrl=require("./path-or-url"),Options=require("./options"),util=require("./util"),_reduce=require("lodash/collection/reduce");module.exports=$Refs,$Refs.prototype.keys=function(){return Object.keys(this._$refs)},$Refs.prototype.fileKeys=function(){return _reduce(this._$refs,function(r,e,t){return e.pathOrUrl.isFile&&r.push(t),r},[])},$Refs.prototype.urlKeys=function(){return _reduce(this._$refs,function(r,e,t){return e.pathOrUrl.isUrl&&r.push(t),r},[])},$Refs.prototype.exists=function(r,e){try{return this.get(r,e),!0}catch(t){return!1}},$Refs.prototype.get=function(r,e){return this._resolve(r,e).value},$Refs.prototype.getAll=function(){return _reduce(this._$refs,function(r,e,t){return r[t]=e.value,r},{})},$Refs.prototype.toJSON=$Refs.prototype.getAll,$Refs.prototype.set=function(r,e,t){var s=new PathOrUrl(r,{allowFileHash:!0}),o=new PathOrUrl(s);o.hash="";var n=this._$refs[o.format()];if(!n)throw util.newError('Error resolving $ref pointer "%s". \n"%s" not found.',r,s);s.hash||(n.value=e),t=new Options(t),n.set(s,e,t)},$Refs.prototype._resolve=function(r,e){var t=new PathOrUrl(r,{allowFileHash:!0}),s=new PathOrUrl(t);s.hash="";var o=this._$refs[s.format()];if(!o)throw util.newError('Error resolving $ref pointer "%s". \n"%s" not found.',r,t);return t.hash?(e=new Options(e),o.resolve(t,e)):{pathOrUrl:o.pathOrUrl,value:o.value}},$Refs.prototype._get$Ref=function(r){return r.hash&&(r=new PathOrUrl(r),r.hash=""),this._$refs[r.format()]},$Refs.prototype._set$Ref=function(r){r.pathOrUrl.hash&&(r.pathOrUrl.hash="",r.pathOrUrl=new PathOrUrl(r.pathOrUrl.format())),r.$refs=this,this._$refs[r.pathOrUrl.format()]=r};

},{"./options":3,"./path-or-url":5,"./util":11,"lodash/collection/reduce":49}],10:[function(require,module,exports){
"use strict";function resolve(r,e){try{if(!e.$refs.external)return Promise.resolve();util.debug("Resolving $ref pointers in %s",r._base);var a=crawl(r.schema,r._base,r,e);return Promise.all(a)}catch(i){return Promise.reject(i)}}function crawl(r,e,a,i){var t=[];return(_isObject(r)||_isArray(r))&&_forEach(r,function(r,l){var s=new PathOrUrl(e);if(s.hash+="/"+l,isExternal$Ref(l,r)){util.debug('Resolving $ref pointer "%s" at %s, relative to %s',r,s,e);var n=e.resolve(r,{allowFileHash:!0}),o=new PathOrUrl(n,{allowFileHash:!0}),u=crawl$Ref(o,a,i)["catch"](function(r){throw util.newError(SyntaxError,r,"Error at %s",u.name)});u.name=s.format(),t.push(u)}else t=t.concat(crawl(r,s,a,i))}),t}function crawl$Ref(r,e,a){return read(r,e,a).then(function(r){if(!r.cached){util.debug("Resolving $ref pointers in %s",r.pathOrUrl);var i=crawl(r.value,r.pathOrUrl,e,a);return Promise.all(i)}})}function isExternal$Ref(r,e){return"$ref"===r&&e&&_isString(e)&&"#"!==e[0]}var Promise=require("./promise"),PathOrUrl=require("./path-or-url"),read=require("./read"),util=require("./util"),_forEach=require("lodash/collection/forEach"),_isArray=require("lodash/lang/isArray"),_isObject=require("lodash/lang/isObject"),_isString=require("lodash/lang/isString");module.exports=resolve;
...
(function (process){
"use strict";function doCallback(r,e,n){function a(){r.apply(null,l)}if(_isFunction(r)){var l=slice.call(arguments,1);process.browser?process.nextTick(a):setImmediate(a)}}function newError(r,e,n,a){return _isFunction(r)&&e instanceof Error?makeError(r,e,format.apply(null,slice.call(arguments,2))):_isFunction(r)?makeError(r,null,format.apply(null,slice.call(arguments,1))):e instanceof Error?makeError(Error,e,format.apply(null,slice.call(arguments,1))):makeError(Error,null,format.apply(null,arguments))}function makeError(r,e,n){e&&(n+=" \n"+(e.name||"Error")+": "+e.message);var a=new r(n);return e&&_isString(e.stack)&&(a.stack+=" \n\n"+e.stack),a}var debug=require("debug"),format=require("util").format,_isFunction=require("lodash/lang/isFunction"),_isString=require("lodash/lang/isString"),slice=Array.prototype.slice;module.exports={debug:debug("json-schema-ref-parser"),doCallback:doCallback,newError:newError};
...
},{"./_stream_duplex":137,"_process":131,"buffer":122,"core-util-is":142,"events":126,"inherits":128,"isarray":129,"process-nextick-args":143,"stream":149,"string_decoder/":159,"util":121}],140:[function(require,module,exports){
...
},{"./_stream_duplex":137,"buffer":122,"core-util-is":142,"events":126,"inherits":128,"process-nextick-args":143,"stream":149,"util-deprecate":144}],142:[function(require,module,exports){
(function (Buffer){
...
},{"./lib/_stream_duplex.js":137,"./lib/_stream_passthrough.js":138,"./lib/_stream_readable.js":139,"./lib/_stream_transform.js":140,"./lib/_stream_writable.js":141,"stream":149}],147:[function(require,module,exports){
