 ...
 * @license MIT
 */
"use strict";function bundle(e,r){util.debug("Bundling $ref pointers in %s",e._basePath);var t=e.$refs;util.path.stripHash(e._basePath);Object.keys(t._$refs).forEach(function(u){var a=t._$refs[u];a.pathFromRoot&&crawl(a.value,a.path+"#",a.pathFromRoot,e.$refs,r)})}function crawl(e,r,t,u,a){e&&"object"==typeof e&&Object.keys(e).forEach(function(f){var i=r+"/"+f,s=e[f];if($Ref.is$Ref(s)){util.debug('Bundling $ref pointer "%s" at %s',s.$ref,i);var l=url.resolve(r,s.$ref),o=u._resolve(l,a);o.$ref}else crawl(s,i,t,u,a)})}var $Ref=require("./ref"),util=require("./util"),url=require("url");module.exports=bundle;

},{"./ref":9,"./util":12,"url":90}],2:[function(require,module,exports){
"use strict";function dereference(e,r){util.debug("Dereferencing $ref pointers in %s",e._basePath),crawl(e.schema,e._basePath+"#",[],e.$refs,r)}function crawl(e,r,f,i,u){e&&"object"==typeof e&&(f.push(e),Object.keys(e).forEach(function(l){var t=r+"/"+l,a=e[l];if($Ref.isAllowed$Ref(a,u)){util.debug('Dereferencing $ref pointer "%s" at %s',a.$ref,t);var n=url.resolve(r,a.$ref),s=i._resolve(n,u);e[l]=a=s.value,-1===f.indexOf(a)&&crawl(s.value,s.path+"#",f,i,u)}else-1===f.indexOf(a)&&crawl(a,t,f,i,u)}),f.pop())}var $Ref=require("./ref"),util=require("./util"),url=require("url");module.exports=dereference;
...
"use strict";function Pointer(e,t){this.$ref=e,this.path=t,this.value=void 0}function resolveIf$Ref(e,t){if($Ref.isAllowed$Ref(e.value,t)){var r=url.resolve(e.path,e.value.$ref);if(r!==e.path){var s=e.$ref.$refs._resolve(r);e.$ref=s.$ref,e.path=s.path,e.value=s.value}}}function setValue(e,t,r){if(!e.value||"object"!=typeof e.value)throw ono.syntax('Error assigning $ref pointer "%s". \nCannot set "%s" of a non-object.',e.path,t);return"-"===t&&Array.isArray(e.value)?e.value.push(r):e.value[t]=r,r}module.exports=Pointer;var $Ref=require("./ref"),util=require("./util"),url=require("url"),ono=require("ono"),escapedSlash=/~1/g,escapedTilde=/~0/g;Pointer.prototype.resolve=function(e,t){var r=Pointer.parse(this.path);this.value=e;for(var s=0;s<r.length;s++){resolveIf$Ref(this,t);var i=r[s];if(void 0===this.value[i])throw ono.syntax('Error resolving $ref pointer "%s". \nToken "%s" does not exist.',path,i);this.value=this.value[i]}return resolveIf$Ref(this,t),this},Pointer.prototype.set=function(e,t,r){var s=Pointer.parse(this.path);if(0===s.length)return this.value=t,t;this.value=e;for(var i=0;i<s.length-1;i++){resolveIf$Ref(this,r);var a=s[i];this.value&&void 0!==this.value[a]?this.value=this.value[a]:this.value=setValue(this,a,{})}return resolveIf$Ref(this,r),a=s[s.length-1],setValue(this,a,t),e},Pointer.parse=function(e){var t=util.path.getHash(e).substr(1);if(!t)return[];t=t.split("/");for(var r=0;r<t.length;r++)t[r]=t[r].replace(escapedSlash,"/").replace(escapedTilde,"~");if(""!==t[0])throw ono.syntax('Invalid $ref pointer "%s". Pointers must begin with "#/"',t);return t.slice(1)};
...
(function (process){
"use strict";var protocolPattern=/^[a-z0-9.+-]+:\/\//i;exports.cwd=function(){return process.browser?location.href:process.cwd()+"/"},exports.isUrl=function(r){return protocolPattern.test(r)},exports.getHash=function(r){var t=r.indexOf("#");return t>=0?r.substr(t):""},exports.stripHash=function(r){var t=r.indexOf("#");return t>=0&&(r=r.substr(0,t)),r},exports.extname=function(r){var t=r.lastIndexOf(".");return t>=0?r.substr(t).toLowerCase():""};
