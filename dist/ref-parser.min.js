...
"use strict";function dereference(e,r){util.debug("Dereferencing $ref pointers in %s",e._basePath),crawl(e.schema,e._basePath,[],e.$refs,r)}function crawl(e,r,f,t,n){e&&"object"==typeof e&&(f.push(e),r=util.path.ensureHash(r),Object.keys(e).forEach(function(i){var c=r+"/"+i,u=e[i];if($Ref.isAllowed$Ref(u,n)){util.debug('Dereferencing $ref pointer "%s" at %s',u.$ref,c);var l=url.resolve(r,u.$ref),s=t._resolve(l,n);u=dereference$Ref(e,i,s.value),-1===f.indexOf(u)&&crawl(u,s.path,f,t,n)}else-1===f.indexOf(u)&&crawl(u,c,f,t,n)}),f.pop())}function dereference$Ref(e,r,f){var t=e[r];return f&&"object"==typeof f&&Object.keys(t).length>1?(delete t.$ref,void Object.keys(f).forEach(function(e){e in t||(t[e]=f[e])})):e[r]=f}var $Ref=require("./ref"),util=require("./util"),url=require("url");module.exports=dereference;

},{"./ref":9,"./util":12,"url":90}],3:[function(require,module,exports){
(function (Buffer){
"use strict";function $RefParser(){this.schema=null,this.$refs=new $Refs,this._basePath=""}function normalizeArgs(e){var r=e[1],t=e[2];return"function"==typeof r&&(t=r,r=void 0),r instanceof Options||(r=new Options(r)),{schema:e[0],options:r,callback:t}}var Promise=require("./promise"),Options=require("./options"),$Refs=require("./refs"),$Ref=require("./ref"),read=require("./read"),resolve=require("./resolve"),bundle=require("./bundle"),dereference=require("./dereference"),util=require("./util"),url=require("url"),ono=require("ono");module.exports=$RefParser,module.exports.YAML=require("./yaml"),$RefParser.parse=function(e,r,t){var a=this;return(new a).parse(e,r,t)},$RefParser.prototype.parse=function(e,r,t){var a=normalizeArgs(arguments);if(a.schema&&"object"==typeof a.schema){this.schema=a.schema,this._basePath="";var s=new $Ref(this.$refs,this._basePath);return s.setValue(this.schema,a.options),util.doCallback(a.callback,null,this.schema),Promise.resolve(this.schema)}if(!a.schema||"string"!=typeof a.schema){var n=ono("Expected a file path, URL, or object. Got %s",a.schema);return util.doCallback(a.callback,n,a.schema),Promise.reject(n)}var c=this;return a.schema=url.resolve(util.path.cwd(),a.schema),this._basePath=util.path.stripHash(a.schema),read(a.schema,this.$refs,a.options).then(function(e){var r=e.$ref;if(!r.value||"object"!=typeof r.value||r.value instanceof Buffer)throw ono.syntax('"%s" is not a valid JSON Schema',c._basePath);return c.schema=r.value,util.doCallback(a.callback,null,c.schema),c.schema})["catch"](function(e){return util.doCallback(a.callback,e,c.schema),Promise.reject(e)})},$RefParser.resolve=function(e,r,t){var a=this;return(new a).resolve(e,r,t)},$RefParser.prototype.resolve=function(e,r,t){var a=this,s=normalizeArgs(arguments);return this.parse(s.schema,s.options).then(function(){return resolve(a,s.options)}).then(function(){return util.doCallback(s.callback,null,a.$refs),a.$refs})["catch"](function(e){return util.doCallback(s.callback,e,a.$refs),Promise.reject(e)})},$RefParser.bundle=function(e,r,t){var a=this;return(new a).bundle(e,r,t)},$RefParser.prototype.bundle=function(e,r,t){var a=this,s=normalizeArgs(arguments);return this.resolve(s.schema,s.options).then(function(){return bundle(a,s.options),util.doCallback(s.callback,null,a.schema),a.schema})["catch"](function(e){return util.doCallback(s.callback,e,a.schema),Promise.reject(e)})},$RefParser.dereference=function(e,r,t){var a=this;return(new a).dereference(e,r,t)},$RefParser.prototype.dereference=function(e,r,t){var a=this,s=normalizeArgs(arguments);return this.resolve(s.schema,s.options).then(function(){return dereference(a,s.options),util.doCallback(s.callback,null,a.schema),a.schema})["catch"](function(e){return util.doCallback(s.callback,e,a.schema),Promise.reject(e)})};
...
},{"./_stream_duplex":67,"_process":61,"buffer":53,"core-util-is":72,"events":57,"inherits":59,"isarray":60,"process-nextick-args":73,"stream":79,"string_decoder/":89,"util":52}],70:[function(require,module,exports){
...
},{"./_stream_duplex":67,"buffer":53,"core-util-is":72,"events":57,"inherits":59,"process-nextick-args":73,"stream":79,"util-deprecate":74}],72:[function(require,module,exports){
(function (Buffer){
...
},{"./lib/_stream_duplex.js":67,"./lib/_stream_passthrough.js":68,"./lib/_stream_readable.js":69,"./lib/_stream_transform.js":70,"./lib/_stream_writable.js":71,"stream":79}],77:[function(require,module,exports){
