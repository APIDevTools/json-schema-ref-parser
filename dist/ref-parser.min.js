 ...
 * @license MIT
 */
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.$RefParser=f()}})(function(){var define,module,exports;return function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r}()({1:[function(require,module,exports){"use strict";exports.__esModule=!0;var ref_1=require("./ref"),pointer_1=require("./pointer"),debug_1=require("./util/debug"),url_1=require("./util/url");function bundle(e,r){debug_1.default("Bundling $ref pointers in %s",e.$refs._root$Ref.path);var t=[];crawl(e,"schema",e.$refs._root$Ref.path+"#","#",0,t,e.$refs,r),remap(t)}function crawl(e,r,t,n,i,f,o,a){var l=null===r?e:e[r];l&&"object"==typeof l&&(ref_1.default.isAllowed$Ref(l)?inventory$Ref(e,r,t,n,i,f,o,a):Object.keys(l).sort(function(e,r){return"definitions"===e?-1:"definitions"===r?1:e.length-r.length}).forEach(function(e){var r=pointer_1.default.join(t,e),u=pointer_1.default.join(n,e),d=l[e];ref_1.default.isAllowed$Ref(d)?inventory$Ref(l,e,t,u,i,f,o,a):crawl(l,e,r,u,i,f,o,a)}))}function inventory$Ref(e,r,t,n,i,f,o,a){var l=null===r?e:e[r],u=url_1.resolve(t,l.$ref),d=o._resolve(u,a),h=pointer_1.default.parse(n).length,s=url_1.stripHash(d.path),p=url_1.getHash(d.path),c=s!==o._root$Ref.path,$=ref_1.default.isExtended$Ref(l);i+=d.indirections;var v=findInInventory(f,e,r);if(v){if(!(h<v.depth||i<v.indirections))return;removeFromInventory(f,v)}f.push({$ref:l,parent:e,key:r,pathFromRoot:n,depth:h,file:s,hash:p,value:d.value,circular:d.circular,extended:$,external:c,indirections:i}),crawl(d.value,null,d.path,n,i+1,f,o,a)}function remap(e){var r,t,n;e.sort(function(e,r){if(e.file!==r.file)return e.file<r.file?-1:1;if(e.hash!==r.hash)return e.hash<r.hash?-1:1;if(e.circular!==r.circular)return e.circular?-1:1;if(e.extended!==r.extended)return e.extended?1:-1;if(e.indirections!==r.indirections)return e.indirections-r.indirections;if(e.depth!==r.depth)return e.depth-r.depth;var t=e.pathFromRoot.lastIndexOf("/definitions"),n=r.pathFromRoot.lastIndexOf("/definitions");return t!==n?n-t:e.pathFromRoot.length-r.pathFromRoot.length}),e.forEach(function(e){debug_1.default('Re-mapping $ref pointer "%s" at %s',e.$ref.$ref,e.pathFromRoot),e.external?e.file===r&&e.hash===t?e.$ref.$ref=n:e.file===r&&0===e.hash.indexOf(t+"/")?e.$ref.$ref=pointer_1.default.join(n,pointer_1.default.parse(e.hash)):(r=e.file,t=e.hash,n=e.pathFromRoot,e.$ref=e.parent[e.key]=ref_1.default.dereference(e.$ref,e.value),e.circular&&(e.$ref.$ref=e.pathFromRoot)):e.$ref.$ref=e.hash,debug_1.default("    new value: %s",e.$ref&&e.$ref.$ref?e.$ref.$ref:"[object Object]")})}function findInInventory(e,r,t){for(var n=0;n<e.length;n++){var i=e[n];if(i.parent===r&&i.key===t)return i}}function removeFromInventory(e,r){var t=e.indexOf(r);e.splice(t,1)}exports.default=bundle},{"./pointer":11,"./ref":12,"./util/debug":17,"./util/url":19}],2:[function(require,module,exports){"use strict";exports.__esModule=!0;var ref_1=require("./ref"),pointer_1=require("./pointer"),ono=require("ono"),debug_1=require("./util/debug"),url_1=require("./util/url");function dereference(e,r){debug_1.default("Dereferencing $ref pointers in %s",e.$refs._root$Ref.path);var u=crawl(e.schema,e.$refs._root$Ref.path,"#",[],e.$refs,r);e.$refs.circular=u.circular,e.schema=u.value}function crawl(e,r,u,c,f,a){var l,i={value:e,circular:!1};return e&&"object"==typeof e&&(c.push(e),ref_1.default.isAllowed$Ref(e,a)?(l=dereference$Ref(e,r,u,c,f,a),i.circular=l.circular,i.value=l.value):Object.keys(e).forEach(function(n){var o=pointer_1.default.join(r,n),t=pointer_1.default.join(u,n),d=e[n],s=!1;ref_1.default.isAllowed$Ref(d,a)?(s=(l=dereference$Ref(d,o,t,c,f,a)).circular,e[n]=l.value):-1===c.indexOf(d)?(s=(l=crawl(d,o,t,c,f,a)).circular,e[n]=l.value):s=foundCircularReference(o,f,a),i.circular=i.circular||s}),c.pop()),i}function dereference$Ref(e,r,u,c,f,a){debug_1.default('Dereferencing $ref pointer "%s" at %s',e.$ref,r);var l=url_1.resolve(r,e.$ref),i=f._resolve(l,a),n=i.circular,o=n||-1!==c.indexOf(i.value);o&&foundCircularReference(r,f,a);var t=ref_1.default.dereference(e,i.value);if(!o){var d=crawl(t,i.path,u,c,f,a);o=d.circular,t=d.value}return o&&!n&&"ignore"===a.dereference.circular&&(t=e),n&&(t.$ref=u),{circular:o,value:t}}function foundCircularReference(e,r,u){if(r.circular=!0,!u.dereference.circular)throw ono.reference("Circular $ref pointer found at %s",e);return!0}exports.default=dereference},{"./pointer":11,"./ref":12,"./util/debug":17,"./util/url":19,ono:67}],3:[function(require,module,exports){(function(Buffer){"use strict";var normalize_args_1=require("./normalize-args"),refs_1=require("./refs"),parse_1=require("./parse"),resolve_external_1=require("./resolve-external"),bundle_1=require("./bundle"),dereference_1=require("./dereference"),url_1=require("./util/url"),maybe=require("call-me-maybe"),ono=require("ono"),yaml_1=require("./util/yaml"),$RefParser=function(){function e(){this.schema=null,this.$refs=new refs_1.default}return e.parse=function(e,r,t,a){var n=new this;return n.parse.apply(n,arguments)},e.prototype.parse=function(e,r,t,a){var n,s=normalize_args_1.normalizeArgs(arguments);if(!s.path&&!s.schema){var o=ono("Expected a file path, URL, or object. Got %s",s.path||s.schema);return maybe(s.callback,Promise.reject(o))}this.schema=null,this.$refs=new refs_1.default;var i="http";if(url_1.isFileSystemPath(s.path)&&(s.path=url_1.fromFileSystemPath(s.path),i="file"),s.path=url_1.resolve(url_1.cwd(),s.path),s.schema&&"object"==typeof s.schema){var l=this.$refs._add(s.path);l.value=s.schema,l.pathType=i,n=Promise.resolve(s.schema)}else n=parse_1.default(s.path,this.$refs,s.options);var u=this;return maybe(s.callback,n.then(function(e){if(!e||"object"!=typeof e||Buffer.isBuffer(e))throw ono.syntax('"%s" is not a valid JSON Schema',u.$refs._root$Ref?u.$refs._root$Ref.path:e);return u.schema=e,u.schema}))},e.resolve=function(e,r,t,a){var n=new this;return n.resolve.apply(n,arguments)},e.prototype.resolve=function(e,r,t,a){var n=this,s=normalize_args_1.normalizeArgs(arguments);return maybe(s.callback,this.parse(s.path,s.schema,s.options).then(function(){return resolve_external_1.default(n,s.options)}).then(function(){return n.$refs}))},e.bundle=function(e,r,t,a){var n=new this;return n.bundle.apply(n,arguments)},e.prototype.bundle=function(e,r,t,a){var n=this,s=normalize_args_1.normalizeArgs(arguments);return maybe(s.callback,this.resolve(s.path,s.schema,s.options).then(function(){return bundle_1.default(n,s.options),n.schema}))},e.dereference=function(e,r,t,a){var n=new this;return n.dereference.apply(n,arguments)},e.prototype.dereference=function(e,r,t,a){var n=this,s=normalize_args_1.normalizeArgs(arguments);return maybe(s.callback,this.resolve(s.path,s.schema,s.options).then(function(){return dereference_1.default(n,s.options),n.schema}))},e}();$RefParser.YAML=yaml_1.default,module.exports=$RefParser}).call(this,{isBuffer:require("../node_modules/is-buffer/index.js")})},{"../node_modules/is-buffer/index.js":34,"./bundle":1,"./dereference":2,"./normalize-args":4,"./parse":6,"./refs":13,"./resolve-external":14,"./util/url":19,"./util/yaml":20,"call-me-maybe":25,ono:67}],4:[function(require,module,exports){"use strict";exports.__esModule=!0;var options_1=require("./options");function normalizeArgs(o){var t,e,r,n;return"function"==typeof(o=Array.prototype.slice.call(o))[o.length-1]&&(n=o.pop()),"string"==typeof o[0]?(t=o[0],"object"==typeof o[2]?(e=o[1],r=o[2]):(e=void 0,r=o[1])):(t="",e=o[0],r=o[1]),r instanceof options_1.default||(r=new options_1.default(r)),{path:t,schema:e,options:r,callback:n}}exports.normalizeArgs=normalizeArgs},{"./options":5}],5:[function(require,module,exports){"use strict";exports.__esModule=!0;var json_1=require("./parsers/json"),yaml_1=require("./parsers/yaml"),text_1=require("./parsers/text"),binary_1=require("./parsers/binary"),file_1=require("./resolvers/file"),http_1=require("./resolvers/http"),$RefParserOptions=function(){function e(r){this.parse=merge({},e.defaults.parse),this.resolve=merge({},e.defaults.resolve),this.dereference=merge({},e.defaults.dereference),merge(this,r)}return e.defaults={parse:{json:json_1.default,yaml:yaml_1.default,text:text_1.default,binary:binary_1.default},resolve:{file:file_1.default,http:http_1.default,external:!0},dereference:{circular:!0}},e}();function merge(e,r){if(isMergeable(r))for(var t=Object.keys(r),s=0;s<t.length;s++){var a=t[s],i=r[a],l=e[a];isMergeable(i)?e[a]=merge(l||{},i):void 0!==i&&(e[a]=i)}return e}function isMergeable(e){return e&&"object"==typeof e&&!Array.isArray(e)&&!(e instanceof RegExp)&&!(e instanceof Date)}exports.default=$RefParserOptions},{"./parsers/binary":7,"./parsers/json":8,"./parsers/text":9,"./parsers/yaml":10,"./resolvers/file":15,"./resolvers/http":16}],6:[function(require,module,exports){(function(Buffer){"use strict";exports.__esModule=!0;var ono=require("ono"),debug_1=require("./util/debug"),url_1=require("./util/url"),plugins_1=require("./util/plugins");function parse(r,e,n){try{r=url_1.stripHash(r);var t=e._add(r),u={url:r,extension:url_1.getExtension(r)};return readFile(u,n).then(function(r){return t.pathType=r.plugin.name,u.data=r.result,parseFile(u,n)}).then(function(r){return t.value=r.result,r.result})}catch(r){return Promise.reject(r)}}function readFile(r,e){debug_1.default("Reading %s",r.url);var n=plugins_1.all(e.resolve);return n=plugins_1.filter(n,"canRead",r),n=plugins_1.sort(n),plugins_1.run(n,"read",r).catch(function(e){throw!e||e instanceof SyntaxError?ono.syntax('Unable to resolve $ref pointer "%s"',r.url):e})}function parseFile(r,e){debug_1.default("Parsing %s",r.url);var n=plugins_1.all(e.parse),t=plugins_1.filter(n,"canParse",r),u=t.length>0?t:n;return u=plugins_1.sort(u),plugins_1.run(u,"parse",r).then(function(e){if(!e.plugin.allowEmpty&&isEmpty(e.result))throw ono.syntax('Error parsing "%s" as %s. \nParsed value is empty',r.url,e.plugin.name);return e},function(e){throw e?(e=e instanceof Error?e:new Error(e),ono.syntax(e,"Error parsing %s",r.url)):ono.syntax("Unable to parse %s",r.url)})}function isEmpty(r){return void 0===r||"object"==typeof r&&0===Object.keys(r).length||"string"==typeof r&&0===r.trim().length||Buffer.isBuffer(r)&&0===r.length}exports.default=parse}).call(this,{isBuffer:require("../node_modules/is-buffer/index.js")})},{"../node_modules/is-buffer/index.js":34,"./util/debug":17,"./util/plugins":18,"./util/url":19,ono:67}],7:[function(require,module,exports){(function(Buffer){"use strict";exports.__esModule=!0;var BINARY_REGEXP=/\.(jpeg|jpg|gif|png|bmp|ico)$/i;exports.default={order:400,allowEmpty:!0,canParse:function(e){return Buffer.isBuffer(e.data)&&BINARY_REGEXP.test(e.url)},parse:function(e){return Buffer.isBuffer(e.data)?e.data:new Buffer(e.data)}}}).call(this,require("buffer").Buffer)},{buffer:23}],8:[function(require,module,exports){(function(Buffer){"use strict";exports.__esModule=!0,exports.default={order:100,allowEmpty:!0,canParse:".json",parse:function(e){return new Promise(function(r,t){var o=e.data;Buffer.isBuffer(o)&&(o=o.toString()),"string"==typeof o?0===o.trim().length?r(void 0):r(JSON.parse(o)):r(o)})}}}).call(this,{isBuffer:require("../../node_modules/is-buffer/index.js")})},{"../../node_modules/is-buffer/index.js":34}],9:[function(require,module,exports){(function(Buffer){"use strict";exports.__esModule=!0;var TEXT_REGEXP=/\.(txt|htm|html|md|xml|js|min|map|css|scss|less|svg)$/i;exports.default={order:300,allowEmpty:!0,encoding:"utf8",canParse:function(t){return("string"==typeof t.data||Buffer.isBuffer(t.data))&&TEXT_REGEXP.test(t.url)},parse:function(t){if("string"==typeof t.data)return t.data;if(Buffer.isBuffer(t.data))return t.data.toString(this.encoding);throw new Error("data is not text")}}}).call(this,{isBuffer:require("../../node_modules/is-buffer/index.js")})},{"../../node_modules/is-buffer/index.js":34}],10:[function(require,module,exports){(function(Buffer){"use strict";exports.__esModule=!0;var yaml_1=require("../util/yaml");exports.default={order:200,allowEmpty:!0,canParse:[".yaml",".yml",".json"],parse:function(e){return new Promise(function(r,t){var a=e.data;Buffer.isBuffer(a)&&(a=a.toString()),r("string"==typeof a?yaml_1.default.parse(a):a)})}}}).call(this,{isBuffer:require("../../node_modules/is-buffer/index.js")})},{"../../node_modules/is-buffer/index.js":34,"../util/yaml":20}],11:[function(require,module,exports){"use strict";exports.__esModule=!0;var ref_1=require("./ref"),url_1=require("./util/url"),ono=require("ono"),slashes=/\//g,tildes=/~/g,escapedSlash=/~1/g,escapedTilde=/~0/g,Pointer=function(){function e(e,r,t){this.value=void 0,this.circular=!1,this.indirections=0,this.$ref=e,this.path=r,this.originalPath=t||r,this.value=void 0,this.circular=!1,this.indirections=0}return e.prototype.resolve=function(r,t){var i=e.parse(this.path);this.value=r;for(var s=0;s<i.length;s++){resolveIf$Ref(this,t)&&(this.path=e.join(this.path,i.slice(s)));var a=i[s];if(void 0===this.value[a])throw ono.syntax('Error resolving $ref pointer "%s". \nToken "%s" does not exist.',this.originalPath,a);this.value=this.value[a]}return resolveIf$Ref(this,t),this},e.prototype.set=function(r,t,i){var s,a=e.parse(this.path);if(0===a.length)return this.value=t,t;this.value=r;for(var n=0;n<a.length-1;n++)resolveIf$Ref(this,i),s=a[n],this.value&&void 0!==this.value[s]?this.value=this.value[s]:this.value=setValue(this,s,{});return resolveIf$Ref(this,i),setValue(this,s=a[a.length-1],t),r},e.parse=function(e){var r=url_1.getHash(e).substr(1);if(!r)return[];r=r.split("/");for(var t=0;t<r.length;t++)r[t]=decodeURIComponent(r[t].replace(escapedSlash,"/").replace(escapedTilde,"~"));if(""!==r[0])throw ono.syntax('Invalid $ref pointer "%s". Pointers must begin with "#/"',r);return r.slice(1)},e.join=function(e,r){-1===e.indexOf("#")&&(e+="#"),r=Array.isArray(r)?r:[r];for(var t=0;t<r.length;t++){var i=r[t];e+="/"+encodeURIComponent(i.replace(tildes,"~0").replace(slashes,"~1"))}return e},e}();function resolveIf$Ref(e,r){if(ref_1.default.isAllowed$Ref(e.value,r)){var t=url_1.resolve(e.path,e.value.$ref);if(t!==e.path){var i=e.$ref.$refs._resolve(t,r);return e.indirections+=i.indirections+1,ref_1.default.isExtended$Ref(e.value)?(e.value=ref_1.default.dereference(e.value,i.value),!1):(e.$ref=i.$ref,e.path=i.path,e.value=i.value,!0)}e.circular=!0}}function setValue(e,r,t){if(!e.value||"object"!=typeof e.value)throw ono.syntax('Error assigning $ref pointer "%s". \nCannot set "%s" of a non-object.',e.path,r);return"-"===r&&Array.isArray(e.value)?e.value.push(t):e.value[r]=t,t}exports.default=Pointer},{"./ref":12,"./util/url":19,ono:67}],12:[function(require,module,exports){"use strict";exports.__esModule=!0;var pointer_1=require("./pointer"),$Ref=function(){function e(){this.path=void 0,this.value=void 0,this.$refs=void 0,this.pathType=void 0}return e.prototype.exists=function(e,t){try{return this.resolve(e,t),!0}catch(e){return!1}},e.prototype.get=function(e,t){return this.resolve(e,t).value},e.prototype.resolve=function(e,t,r){return new pointer_1.default(this,e,r).resolve(this.value,t)},e.prototype.set=function(e,t){var r=new pointer_1.default(this,e);this.value=r.set(this.value,t)},e.is$Ref=function(e){return e&&"object"==typeof e&&"string"==typeof e.$ref&&e.$ref.length>0},e.isExternal$Ref=function(t){return e.is$Ref(t)&&"#"!==t.$ref[0]},e.isAllowed$Ref=function(t,r){if(e.is$Ref(t)){if("#/"===t.$ref.substr(0,2)||"#"===t.$ref)return!0;if("#"!==t.$ref[0]&&(!r||r.resolve.external))return!0}},e.isExtended$Ref=function(t){return e.is$Ref(t)&&Object.keys(t).length>1},e.dereference=function(t,r){if(r&&"object"==typeof r&&e.isExtended$Ref(t)){var n={};return Object.keys(t).forEach(function(e){"$ref"!==e&&(n[e]=t[e])}),Object.keys(r).forEach(function(e){e in n||(n[e]=r[e])}),n}return r},e}();exports.default=$Ref},{"./pointer":11}],13:[function(require,module,exports){"use strict";exports.__esModule=!0;var ono=require("ono"),ref_1=require("./ref"),url_1=require("./util/url"),$Refs=function(){function r(){this.circular=!1,this._$refs={},this._root$Ref=null,this.toJSON=this.values}return r.prototype.paths=function(r){return getPaths(this._$refs,arguments).map(function(r){return r.decoded})},r.prototype.values=function(r){var t=this._$refs;return getPaths(t,arguments).reduce(function(r,e){return r[e.decoded]=t[e.encoded].value,r},{})},r.prototype.exists=function(r,t){try{return this._resolve(r,t),!0}catch(r){return!1}},r.prototype.get=function(r,t){return this._resolve(r,t).value},r.prototype.set=function(r,t){var e=url_1.resolve(this._root$Ref.path,r),o=url_1.stripHash(e),s=this._$refs[o];if(!s)throw ono('Error resolving $ref pointer "%s". \n"%s" not found.',r,o);s.set(e,t)},r.prototype._add=function(r){var t=url_1.stripHash(r),e=new ref_1.default;return e.path=t,e.$refs=this,this._$refs[t]=e,this._root$Ref=this._root$Ref||e,e},r.prototype._resolve=function(r,t){var e=url_1.resolve(this._root$Ref.path,r),o=url_1.stripHash(e),s=this._$refs[o];if(!s)throw ono('Error resolving $ref pointer "%s". \n"%s" not found.',r,o);return s.resolve(e,t,r)},r.prototype._get$Ref=function(r){r=url_1.resolve(this._root$Ref.path,r);var t=url_1.stripHash(r);return this._$refs[t]},r}();function getPaths(r,t){var e=Object.keys(r),o=Array.isArray(t[0])?t[0]:Array.prototype.slice.call(t);return t.length>0&&t[0]&&(e=e.filter(function(t){return-1!==o.indexOf(r[t].pathType)})),e.map(function(t){return{encoded:t,decoded:"file"===r[t].pathType?url_1.toFileSystemPath(t,!0):t}})}exports.default=$Refs},{"./ref":12,"./util/url":19,ono:67}],14:[function(require,module,exports){"use strict";exports.__esModule=!0;var ref_1=require("./ref"),pointer_1=require("./pointer"),parse_1=require("./parse"),debug_1=require("./util/debug"),url_1=require("./util/url");function resolveExternal(e,r){if(!r.resolve.external)return Promise.resolve();try{debug_1.default("Resolving $ref pointers in %s",e.$refs._root$Ref.path);var t=crawl(e.schema,e.$refs._root$Ref.path+"#",e.$refs,r);return Promise.all(t)}catch(e){return Promise.reject(e)}}function crawl(e,r,t,s){var l=[];return e&&"object"==typeof e&&(ref_1.default.isExternal$Ref(e)?l.push(resolve$Ref(e,r,t,s)):Object.keys(e).forEach(function(u){var o=pointer_1.default.join(r,u),a=e[u];ref_1.default.isExternal$Ref(a)?l.push(resolve$Ref(a,o,t,s)):l.push.apply(l,l.concat(crawl(a,o,t,s)))})),l}function resolve$Ref(e,r,t,s){debug_1.default('Resolving $ref pointer "%s" at %s',e.$ref,r);var l=url_1.resolve(r,e.$ref),u=url_1.stripHash(l),o=t._$refs[u];return o?Promise.resolve(o.value):parse_1.default(l,t,s).then(function(e){debug_1.default("Resolving $ref pointers in %s",u);var r=crawl(e,u+"#",t,s);return Promise.all(r)})}exports.default=resolveExternal},{"./parse":6,"./pointer":11,"./ref":12,"./util/debug":17,"./util/url":19}],15:[function(require,module,exports){"use strict";exports.__esModule=!0;var fs=require("fs"),ono=require("ono"),url_1=require("../util/url"),debug_1=require("../util/debug");exports.default={order:100,canRead:function(r){return url_1.isFileSystemPath(r.url)},read:function(r){return new Promise(function(e,u){var o;try{o=url_1.toFileSystemPath(r.url)}catch(e){u(ono.uri(e,"Malformed URI: %s",r.url))}debug_1.default("Opening file: %s",o);try{fs.readFile(o,function(r,i){r?u(ono(r,'Error opening file "%s"',o)):e(i)})}catch(r){u(ono(r,'Error opening file "%s"',o))}})}}},{"../util/debug":17,"../util/url":19,fs:22,ono:67}],16:[function(require,module,exports){(function(process,Buffer){"use strict";exports.__esModule=!0;var http=require("http"),https=require("https"),ono=require("ono"),url_1=require("../util/url"),debug_1=require("../util/debug");function download(t,e,o){return new Promise(function(r,n){t=url_1.parse(t),(o=o||[]).push(t.href),get(t,e).then(function(s){if(s.statusCode>=400)throw ono({status:s.statusCode},"HTTP ERROR %d",s.statusCode);if(s.statusCode>=300)if(o.length>e.redirects)n(ono({status:s.statusCode},"Error downloading %s. \nToo many redirects: \n  %s",o[0],o.join(" \n  ")));else{if(!s.headers.location)throw ono({status:s.statusCode},"HTTP %d redirect with no location header",s.statusCode);debug_1.default("HTTP %d redirect %s -> %s",s.statusCode,t.href,s.headers.location),download(url_1.resolve(t,s.headers.location),e,o).then(r,n)}else r(s.body||new Buffer(0))}).catch(function(e){n(ono(e,"Error downloading",t.href))})})}function get(t,e,o){return void 0===o&&(o=3),new Promise(function(r,n){debug_1.default("GET",t.href);var s=("https:"===t.protocol?https:http).get({hostname:t.hostname,port:t.port,path:t.path,auth:t.auth,protocol:t.protocol,headers:e.headers||{},withCredentials:e.withCredentials});"function"==typeof s.setTimeout&&s.setTimeout(e.timeout),s.on("timeout",function(){s.abort()}),s.on("error",function(s){"ECONNRESET"===s.code&&o>0?r(get(t,e,o-1)):n(s)}),s.once("response",function(t){t.body=new Buffer(0),t.on("data",function(e){t.body=Buffer.concat([t.body,new Buffer(e)])}),t.on("error",n),t.on("end",function(){r(t)})})})}exports.default={order:200,headers:null,timeout:5e3,redirects:5,withCredentials:!1,canRead:function(t){return url_1.isHttp(t.url)},read:function(t){var e=url_1.parse(t.url);return process.browser&&!e.protocol&&(e.protocol=url_1.parse(location.href).protocol),download(e,this)}}}).call(this,require("_process"),require("buffer").Buffer)},{"../util/debug":17,"../util/url":19,_process:68,buffer:23,http:74,https:31,ono:67}],17:[function(require,module,exports){"use strict";exports.__esModule=!0;var debug_1=require("debug");exports.default=debug_1.default("json-schema-ref-parser")},{debug:27}],18:[function(require,module,exports){"use strict";exports.__esModule=!0;var debug_1=require("./debug");function all(e){return Object.keys(e).filter(function(r){return"object"==typeof e[r]}).map(function(r){return e[r].name=r,e[r]})}function filter(e,r,t){return e.filter(function(e){return!!getResult(e,r,t)})}function sort(e){return e.forEach(function(e){e.order=e.order||Number.MAX_SAFE_INTEGER}),e.sort(function(e,r){return e.order-r.order})}function run(e,r,t){var n,o,u=0;return new Promise(function(f,i){function s(){if(!(n=e[u++]))return i(o);try{debug_1.default("  %s",n.name);var f=getResult(n,r,t,c);"object"==typeof f&&"function"==typeof f.then?f.then(l,a):void 0!==f&&l(f)}catch(e){a(e)}}function c(e,r){e?a(e):l(r)}function l(e){debug_1.default("    success"),f({plugin:n,result:e})}function a(e){debug_1.default("    %s",e.message||e),o=e,s()}s()})}function getResult(e,r,t,n){var o=e[r];if("function"==typeof o)return e[r](t,n);if(!n){if(o instanceof RegExp)return o.test(t.url);if("string"==typeof o)return o===t.extension;if(Array.isArray(o))return-1!==o.indexOf(t.extension)}if(!n&&"boolean"!=typeof o)throw console.error([e,r,t,n]),new Error("How did we get here?");return o}exports.all=all,exports.filter=filter,exports.sort=sort,exports.run=run},{"./debug":17}],19:[function(require,module,exports){(function(process){"use strict";exports.__esModule=!0;var isWindows=/^win/.test(process.platform),forwardSlashPattern=/\//g,protocolPattern=/^(\w{2,}):\/\//i,url=module.exports,urlEncodePatterns=[/\?/g,"%3F",/\#/g,"%23"],urlDecodePatterns=[/\%23/g,"#",/\%24/g,"$",/\%26/g,"&",/\%2C/g,",",/\%40/g,"@"],url_1=require("url");function cwd(){return process.browser?location.href:process.cwd()+"/"}function getProtocol(t){var e=protocolPattern.exec(t);if(e)return e[1].toLowerCase()}function getExtension(t){var e=t.lastIndexOf(".");return e>=0?t.substr(e).toLowerCase():""}function getHash(t){var e=t.indexOf("#");return e>=0?t.substr(e):"#"}function stripHash(t){var e=t.indexOf("#");return e>=0&&(t=t.substr(0,e)),t}function isHttp(t){var e=getProtocol(t);return"http"===e||"https"===e||void 0===e&&process.browser}function isFileSystemPath(t){if(process.browser)return!1;var e=getProtocol(t);return void 0===e||"file"===e}function fromFileSystemPath(t){isWindows&&(t=t.replace(/\\/g,"/")),t=encodeURI(t);for(var e=0;e<urlEncodePatterns.length;e+=2)t=t.replace(urlEncodePatterns[e],urlEncodePatterns[e+1]);return t}function toFileSystemPath(t,e){t=decodeURI(t);for(var r=0;r<urlDecodePatterns.length;r+=2)t=t.replace(urlDecodePatterns[r],urlDecodePatterns[r+1]);var s="file://"===t.substr(0,7).toLowerCase();return s&&(t="/"===t[7]?t.substr(8):t.substr(7),isWindows&&"/"===t[1]&&(t=t[0]+":"+t.substr(1)),e?t="file:///"+t:(s=!1,t=isWindows?t:"/"+t)),isWindows&&!s&&":\\"===(t=t.replace(forwardSlashPattern,"\\")).substr(1,2)&&(t=t[0].toUpperCase()+t.substr(1)),t}exports.parse=url_1.parse,exports.resolve=url_1.resolve,exports.cwd=cwd,exports.getProtocol=getProtocol,exports.getExtension=getExtension,exports.getHash=getHash,exports.stripHash=stripHash,exports.isHttp=isHttp,exports.isFileSystemPath=isFileSystemPath,exports.fromFileSystemPath=fromFileSystemPath,exports.toFileSystemPath=toFileSystemPath}).call(this,require("_process"))},{_process:68,url:91}],20:[function(require,module,exports){"use strict";exports.__esModule=!0;var yaml=require("js-yaml"),ono=require("ono");exports.default={parse:function(r,e){try{return yaml.safeLoad(r)}catch(r){throw r instanceof Error?r:ono(r,r.message)}},stringify:function(r,e,t){try{var o=("string"==typeof t?t.length:t)||2;return yaml.safeDump(r,{indent:o})}catch(r){throw r instanceof Error?r:ono(r,r.message)}}}},{"js-yaml":36,ono:67}],21:[function(require,module,exports){"use strict";exports.byteLength=byteLength,exports.toByteArray=toByteArray,exports.fromByteArray=fromByteArray;for(var lookup=[],revLookup=[],Arr="undefined"!=typeof Uint8Array?Uint8Array:Array,code="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",i=0,len=code.length;i<len;++i)lookup[i]=code[i],revLookup[code.charCodeAt(i)]=i;function getLens(o){var r=o.length;if(r%4>0)throw new Error("Invalid string. Length must be a multiple of 4");var e=o.indexOf("=");return-1===e&&(e=r),[e,e===r?0:4-e%4]}function byteLength(o){var r=getLens(o),e=r[0],t=r[1];return 3*(e+t)/4-t}function _byteLength(o,r,e){return 3*(r+e)/4-e}function toByteArray(o){for(var r,e=getLens(o),t=e[0],n=e[1],u=new Arr(_byteLength(o,t,n)),p=0,a=n>0?t-4:t,h=0;h<a;h+=4)r=revLookup[o.charCodeAt(h)]<<18|revLookup[o.charCodeAt(h+1)]<<12|revLookup[o.charCodeAt(h+2)]<<6|revLookup[o.charCodeAt(h+3)],u[p++]=r>>16&255,u[p++]=r>>8&255,u[p++]=255&r;return 2===n&&(r=revLookup[o.charCodeAt(h)]<<2|revLookup[o.charCodeAt(h+1)]>>4,u[p++]=255&r),1===n&&(r=revLookup[o.charCodeAt(h)]<<10|revLookup[o.charCodeAt(h+1)]<<4|revLookup[o.charCodeAt(h+2)]>>2,u[p++]=r>>8&255,u[p++]=255&r),u}function tripletToBase64(o){return lookup[o>>18&63]+lookup[o>>12&63]+lookup[o>>6&63]+lookup[63&o]}function encodeChunk(o,r,e){for(var t,n=[],u=r;u<e;u+=3)t=(o[u]<<16&16711680)+(o[u+1]<<8&65280)+(255&o[u+2]),n.push(tripletToBase64(t));return n.join("")}function fromByteArray(o){for(var r,e=o.length,t=e%3,n=[],u=0,p=e-t;u<p;u+=16383)n.push(encodeChunk(o,u,u+16383>p?p:u+16383));return 1===t?(r=o[e-1],n.push(lookup[r>>2]+lookup[r<<4&63]+"==")):2===t&&(r=(o[e-2]<<8)+o[e-1],n.push(lookup[r>>10]+lookup[r>>4&63]+lookup[r<<2&63]+"=")),n.join("")}revLookup["-".charCodeAt(0)]=62,revLookup["_".charCodeAt(0)]=63},{}],22:[function(require,module,exports){},{}],23:[function(require,module,exports){
/*!
