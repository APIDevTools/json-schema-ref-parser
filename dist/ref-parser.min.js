...
"use strict";function dereference(e,r){debug("Dereferencing $ref pointers in %s",e.$refs._root$Ref.path);var c=crawl(e.schema,e.$refs._root$Ref.path,"#",[],e.$refs,r);e.$refs.circular=c.circular,e.schema=c.value}function crawl(e,r,c,u,n,f){var i,a={value:e,circular:!1};return e&&"object"==typeof e&&(u.push(e),$Ref.isAllowed$Ref(e,f)?(i=dereference$Ref(e,r,c,u,n,f),a.circular=i.circular,a.value=i.value):Object.keys(e).forEach(function(l){var o=Pointer.join(r,l),t=Pointer.join(c,l),d=e[l],s=!1;if($Ref.isAllowed$Ref(d,f))i=dereference$Ref(d,o,t,u,n,f),s=i.circular,e[l]=i.value;else{var $=!1;$=f.dereference&&f.dereference.ignoreNodes&&f.dereference.ignoreNodes.reduce(function(r,c){return r||e[c]},!1),$||(u.indexOf(d)===-1?(i=crawl(d,o,t,u,n,f),s=i.circular,e[l]=i.value):s=foundCircularReference(o,n,f))}a.circular=a.circular||s}),u.pop()),a}function dereference$Ref(e,r,c,u,n,f){debug('Dereferencing $ref pointer "%s" at %s',e.$ref,r);var i=url.resolve(r,e.$ref),a=n._resolve(i,f),l=a.circular,o=l||u.indexOf(a.value)!==-1;o&&foundCircularReference(r,n,f);var t=$Ref.dereference(e,a.value);if(!o){var d=crawl(t,a.path,c,u,n,f);o=d.circular,t=d.value}return o&&!l&&"ignore"===f.dereference.circular&&(t=e),l&&(t.$ref=c),{circular:o,value:t}}function foundCircularReference(e,r,c){if(r.circular=!0,!c.dereference.circular)throw ono.reference("Circular $ref pointer found at %s",e);return!0}var $Ref=require("./ref"),Pointer=require("./pointer"),ono=require("ono"),debug=require("./util/debug"),url=require("./util/url");module.exports=dereference;
...
},{"../util/debug":16,"../util/promise":18,"../util/url":19,"_process":67,"buffer":59,"http":89,"https":64,"ono":57}],16:[function(require,module,exports){
...
},{"_process":67,"url":96}],20:[function(require,module,exports){
"use strict";var yaml=require("js-yaml"),ono=require("ono");module.exports={parse:function(r,e){try{return yaml.safeLoad(r)}catch(r){throw r instanceof Error?r:ono(r,r.message)}},stringify:function(r,e,o){try{var t=("string"==typeof o?o.length:o)||2;return yaml.safeDump(r,{indent:t})}catch(r){throw r instanceof Error?r:ono(r,r.message)}}};
...
},{"util":100}],58:[function(require,module,exports){
...
},{"http":89}],65:[function(require,module,exports){
...
},{"./_stream_readable":75,"./_stream_writable":77,"core-util-is":80,"inherits":65,"process-nextick-args":82}],74:[function(require,module,exports){
...
},{"./_stream_transform":76,"core-util-is":80,"inherits":65}],75:[function(require,module,exports){
(function (process){
...
},{"./_stream_duplex":73,"./internal/streams/BufferList":78,"_process":67,"buffer":59,"buffer-shims":79,"core-util-is":80,"events":63,"inherits":65,"isarray":81,"process-nextick-args":82,"stream":88,"string_decoder/":95,"util":58}],76:[function(require,module,exports){
...
},{"./_stream_duplex":73,"_process":67,"buffer":59,"buffer-shims":79,"core-util-is":80,"events":63,"inherits":65,"process-nextick-args":82,"stream":88,"util-deprecate":83}],78:[function(require,module,exports){
...
},{"buffer":59,"buffer-shims":79}],79:[function(require,module,exports){
(function (global){
...
},{"_process":67}],83:[function(require,module,exports){
(function (global){
...
},{"./lib/_stream_duplex.js":73,"./lib/_stream_passthrough.js":74,"./lib/_stream_readable.js":75,"./lib/_stream_transform.js":76,"./lib/_stream_writable.js":77,"_process":67,"stream":88}],86:[function(require,module,exports){
module.exports=require("./lib/_stream_transform.js");

},{"./lib/_stream_transform.js":76}],87:[function(require,module,exports){
...
},{"events":63,"inherits":65,"readable-stream/duplex.js":72,"readable-stream/passthrough.js":84,"readable-stream/readable.js":85,"readable-stream/transform.js":86,"readable-stream/writable.js":87}],89:[function(require,module,exports){
(function (global){
...
},{"./lib/request":91,"builtin-status-codes":93,"url":96,"xtend":101}],90:[function(require,module,exports){
(function (global){
...
},{"./capability":90,"./response":92,"_process":67,"buffer":59,"inherits":65,"readable-stream":85,"to-arraybuffer":94}],92:[function(require,module,exports){
(function (process,global,Buffer){
...
},{"./capability":90,"_process":67,"buffer":59,"inherits":65,"readable-stream":85}],93:[function(require,module,exports){
...
},{"buffer":59}],95:[function(require,module,exports){
...
},{"buffer":59}],96:[function(require,module,exports){
...
},{"./util":97,"punycode":68,"querystring":71}],97:[function(require,module,exports){
...
},{"./support/isBuffer":99,"_process":67,"inherits":98}],101:[function(require,module,exports){
