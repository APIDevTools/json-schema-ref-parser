 ...
 * @license MIT
 */
"use strict";function bundle(e,r){util.debug("Bundling $ref pointers in %s",e._basePath),crawl(e.schema,"#",e.$refs,r)}function crawl(e,r,t,n){e&&"object"==typeof e&&Object.keys(e).forEach(function(u){var f=r+"/"+u,i=e[u];if($Ref.is$Ref(i)){$Ref.isExternal$Ref(i)&&t._get$Ref(),util.debug('Dereferencing $ref pointer "%s" at %s',i.$ref,f);var l=url.resolve(r,i.$ref),a=t._resolve(l,n);e[u]=i=a.value,-1===parents.indexOf(i)&&crawl(a.value,a.path+"#",parents,t,n)}else-1===parents.indexOf(i)&&crawl(i,f,parents,t,n)})}var $Ref=require("./ref"),util=require("./util"),url=require("url");module.exports=bundle;

},{"./ref":8,"./util":11,"url":88}],2:[function(require,module,exports){
"use strict";function dereference(e,r){util.debug("Dereferencing $ref pointers in %s",e._basePath),crawl(e.schema,e._basePath+"#",[],e.$refs,r)}function crawl(e,r,f,i,u){e&&"object"==typeof e&&(f.push(e),Object.keys(e).forEach(function(l){var t=r+"/"+l,a=e[l];if($Ref.isAllowed(a,u)){util.debug('Dereferencing $ref pointer "%s" at %s',a.$ref,t);var n=url.resolve(r,a.$ref),s=i._resolve(n,u);e[l]=a=s.value,-1===f.indexOf(a)&&crawl(s.value,s.path+"#",f,i,u)}else-1===f.indexOf(a)&&crawl(a,t,f,i,u)}),f.pop())}var $Ref=require("./ref"),util=require("./util"),url=require("url");module.exports=dereference;

},{"./ref":8,"./util":11,"url":88}],3:[function(require,module,exports){
(function (Buffer){
"use strict";function $RefParser(){this.schema=null,this.$refs=new $Refs,this._basePath=""}function normalizeArgs(e){var r=e[1],t=e[2];return"function"==typeof r&&(t=r,r=void 0),r instanceof Options||(r=new Options(r)),{schema:e[0],options:r,callback:t}}var Promise=require("./promise"),Options=require("./options"),$Refs=require("./refs"),read=require("./read"),resolve=require("./resolve"),bundle=require("./bundle"),dereference=require("./dereference"),util=require("./util"),url=require("url"),ono=require("ono");module.exports=$RefParser,module.exports.YAML=require("./yaml"),$RefParser.parse=function(e,r,t){var a=this;return(new a).parse(e,r,t)},$RefParser.prototype.parse=function(e,r,t){var a=normalizeArgs(arguments);if(a.schema&&"object"==typeof a.schema)return this.schema=a.schema,this._basePath="",util.doCallback(a.callback,null,this.schema),Promise.resolve(this.schema);if(!a.schema||"string"!=typeof a.schema){var s=ono("Expected a file path, URL, or object. Got %s",a.schema);return util.doCallback(a.callback,s,a.schema),Promise.reject(s)}var n=this;return a.schema=url.resolve(util.cwd(),a.schema),this._basePath=util.stripHash(a.schema),read(a.schema,this.$refs,a.options).then(function(e){if(!e.value||"object"!=typeof e.value||e.value instanceof Buffer)throw ono.syntax('"%s" is not a valid JSON Schema',n._basePath);return n.schema=e.value,util.doCallback(a.callback,null,n.schema),n.schema})["catch"](function(e){return util.doCallback(a.callback,e),Promise.reject(e)})},$RefParser.resolve=function(e,r,t){var a=this;return(new a).resolve(e,r,t)},$RefParser.prototype.resolve=function(e,r,t){var a=this,s=normalizeArgs(arguments);return this.parse(s.schema,s.options).then(function(){return resolve(a,s.options)}).then(function(){return util.doCallback(s.callback,null,a.$refs),a.$refs})["catch"](function(e){return util.doCallback(s.callback,e,a.$refs),Promise.reject(e)})},$RefParser.bundle=function(e,r,t){var a=this;return(new a).bundle(e,r,t)},$RefParser.prototype.bundle=function(e,r,t){var a=this,s=normalizeArgs(arguments);return this.resolve(s.schema,s.options).then(function(){return bundle(a,s.options),util.doCallback(s.callback,null,a.schema),a.schema})["catch"](function(e){return util.doCallback(s.callback,e,a.schema),Promise.reject(e)})},$RefParser.dereference=function(e,r,t){var a=this;return(new a).dereference(e,r,t)},$RefParser.prototype.dereference=function(e,r,t){var a=this,s=normalizeArgs(arguments);return this.resolve(s.schema,s.options).then(function(){return dereference(a,s.options),util.doCallback(s.callback,null,a.schema),a.schema})["catch"](function(e){return util.doCallback(s.callback,e,a.schema),Promise.reject(e)})};
...
(function (process){
"use strict";function read(e,r,t){try{e=util.stripHash(e),util.debug("Reading %s",e);var o=r._get$Ref(e);return o&&!o.isExpired()?(util.debug("    cached from %s",o.type),o.cached=!0,Promise.resolve(o)):(o=new $Ref(e),r._set$Ref(o),read$Ref(o,t))}catch(n){return Promise.reject(n)}}function read$Ref(e,r){try{var t=r.$refs.external&&(read$RefFile(e,r)||read$RefUrl(e,r));return t?t.then(function(t){var o=parse(t,e.path,r);return e.setValue(o,r),e.cached=!1,e}):Promise.reject(ono.syntax('Unable to resolve $ref pointer "%s"',e.path))}catch(o){return Promise.reject(o)}}function read$RefFile(e,r){return process.browser||util.isUrl(e.path)?void 0:(e.type="fs",new Promise(function(r,t){var o;try{o=decodeURI(e.path)}catch(n){t(ono.uri(n,"Malformed URI: %s",e.path))}util.debug("Opening file: %s",o);try{fs.readFile(o,function(o,n){o?t(ono(o,'Error opening file "%s"',e.path)):r(n)})}catch(n){t(ono(n,'Error opening file "%s"',o))}}))}function read$RefUrl(e,r){var t=url.parse(e.path);return"http:"===t.protocol?(e.type="http",download(http,t,r)):"https:"===t.protocol?(e.type="https",download(https,t,r)):void 0}function download(e,r,t){return new Promise(function(o,n){function i(e){var i;e.on("data",function(e){i=i?i.concat(e):e}),e.on("end",function(){e.statusCode>=400?n(ono("GET %s \nHTTP ERROR %d \n%s",r.href,e.statusCode,i)):204!==e.statusCode&&i&&i.length||t.allow.empty?o(i):n(ono("GET %s \nHTTP 204: No Content",r.href))}),e.on("error",function(e){n(ono(e,'Error downloading file "%s"',r.href))})}try{util.debug("Downloading file: %s",r);var a=e.get({hostname:r.hostname,port:r.port,path:r.path,auth:r.auth},i);"function"==typeof a.setTimeout&&a.setTimeout(5e3),a.on("timeout",function(){a.abort()}),a.on("error",function(e){n(ono(e,'Error downloading file "%s"',r.href))})}catch(s){n(ono(s,'Error downloading file "%s"',r.href))}})}var fs=require("fs"),http=require("http"),https=require("https"),parse=require("./parse"),util=require("./util"),$Ref=require("./ref"),Promise=require("./promise"),url=require("url"),ono=require("ono");module.exports=read;

}).call(this,require('_process'))

},{"./parse":5,"./promise":6,"./ref":8,"./util":11,"_process":59,"fs":49,"http":78,"https":56,"ono":48,"url":88}],8:[function(require,module,exports){
"use strict";function $Ref(e){this.$refs=null,this.path=e,this.value=void 0,this.type="pending",this.expires=void 0}function parseJsonPointer(e){e="#"===e[0]?e.substr(1):e,e=e.split("/");for(var t=0;t<e.length;t++)e[t]=e[t].replace(escapedSlash,"/").replace(escapedTilde,"~");if(""!==e[0])throw ono.syntax('Invalid $ref pointer "%s". Pointers must begin with "#/"',e);return e.slice(1)}function resolveValue(e,t,r){if($Ref.isAllowed(e.value,r)){var i=url.resolve(e.path,e.value.$ref);i!==e.path&&(e.path=i,e.value=t.get(i))}return e}var util=require("./util"),url=require("url"),ono=require("ono"),escapedSlash=/~1/g,escapedTilde=/~0/g;module.exports=$Ref,$Ref.prototype.isExpired=function(){return!!(this.expires&&this.expires<=new Date)},$Ref.prototype.expire=function(){this.expires=new Date},$Ref.prototype.setValue=function(e,t){this.value=e;var r=t.cache[this.type];if(r>0){var i=Date.now()+1e3*r;this.expires=new Date(i)}},$Ref.prototype.exists=function(e){try{return this.resolve(e),!0}catch(t){return!1}},$Ref.prototype.resolve=function(e,t){var r=util.getHash(e),i={path:e,value:this.value};if(!r)return i;for(var s=parseJsonPointer(r),n=0;n<s.length;n++){if(resolveValue(i,this.$refs,t),!(s[n]in i.value))throw ono.syntax('Error resolving $ref pointer "%s". \n"%s" not found.',e,r);i.value=i.value[s[n]]}return resolveValue(i,this.$refs,t)},$Ref.prototype.get=function(e,t){return this.resolve(e,t).value},$Ref.prototype.set=function(e,t,r){var i=util.getHash(e);if(!i)return void(this.value=t);var s=parseJsonPointer(i),n={path:e,value:this.value};try{for(var o=0;o<s.length-1;o++)resolveValue(n,this.$refs,r),s[o]in n.value?n.value=n.value[s[o]]:n.value=n.value[s[o]]={};resolveValue(n,this.$refs,r),n.value[s[s.length-1]]=t}catch(a){throw ono.syntax(a,'Error resolving $ref pointer "%s". \n"%s" not found.',e,i)}},$Ref.is$Ref=function(e){return e&&"object"==typeof e&&"string"==typeof e.$ref&&e.$ref.length>0},$Ref.isExternal$Ref=function(e){return $Ref.is$Ref(e)&&"#"!==e.$ref[0]},$Ref.isAllowed=function(e,t){if($Ref.is$Ref(e))if("#"===e.$ref[0]){if(t.$refs.internal)return!0}else if(t.$refs.external)return!0};
...
"use strict";function resolve(e,r){try{if(!r.$refs.external)return Promise.resolve();util.debug("Resolving $ref pointers in %s",e._basePath);var t=crawl(e.schema,e._basePath+"#",e.$refs,r);return Promise.all(t)}catch(i){return Promise.reject(i)}}function crawl(e,r,t,i){var o=[];return e&&"object"==typeof e&&Object.keys(e).forEach(function(a){var n=r+"/"+a,s=e[a];if($Ref.isExternal$Ref(s)){util.debug('Resolving $ref pointer "%s" at %s',s,n);var u=url.resolve(r,s),l=crawl$Ref(u,t,i)["catch"](function(e){throw ono.syntax(e,"Error at %s",n)});o.push(l)}else o=o.concat(crawl(s,n,t,i))}),o}function crawl$Ref(e,r,t){return read(e,r,t).then(function(e){if(!e.cached){util.debug("Resolving $ref pointers in %s",e.path);var i=crawl(e.value,e.path+"#",r,t);return Promise.all(i)}})}var Promise=require("./promise"),$Ref=require("./ref"),read=require("./read"),util=require("./util"),url=require("url"),ono=require("ono");module.exports=resolve;

},{"./promise":6,"./read":7,"./ref":8,"./util":11,"ono":48,"url":88}],11:[function(require,module,exports){
(function (process){
"use strict";var debug=require("debug"),protocolPattern=/^[a-z0-9.+-]+:\/\//i;exports.debug=debug("json-schema-ref-parser"),exports.cwd=function(){return process.browser?location.href:process.cwd()+"/"},exports.isUrl=function(r){return protocolPattern.test(r)},exports.getHash=function(r){var e=r.indexOf("#");return e>=0?r.substr(e):""},exports.stripHash=function(r){var e=r.indexOf("#");return e>=0&&(r=r.substr(0,e)),r},exports.extname=function(r){var e=r.lastIndexOf(".");return e>=0?r.substr(e).toLowerCase():""},exports.doCallback=function(r,e,t){function s(){r.apply(null,o)}if("function"==typeof r){var o=Array.prototype.slice.call(arguments,1);process.browser?process.nextTick(s):setImmediate(s)}};
...
},{"./_stream_duplex":65,"_process":59,"buffer":51,"core-util-is":70,"events":55,"inherits":57,"isarray":58,"process-nextick-args":71,"stream":77,"string_decoder/":87,"util":50}],68:[function(require,module,exports){
...
},{"./_stream_duplex":65,"buffer":51,"core-util-is":70,"events":55,"inherits":57,"process-nextick-args":71,"stream":77,"util-deprecate":72}],70:[function(require,module,exports){
(function (Buffer){
...
},{"./lib/_stream_duplex.js":65,"./lib/_stream_passthrough.js":66,"./lib/_stream_readable.js":67,"./lib/_stream_transform.js":68,"./lib/_stream_writable.js":69,"stream":77}],75:[function(require,module,exports){
