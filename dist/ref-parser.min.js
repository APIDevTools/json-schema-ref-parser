 ...
 * @license MIT
 */
"use strict";function bundle(e,r){debug("Bundling $ref pointers in %s",e.$refs._root$Ref.path);var t=[];crawl(e.schema,e.$refs._root$Ref.path+"#","#",t,e.$refs,r),remap(t)}function crawl(e,r,t,n,i,f){if(e&&"object"==typeof e){var a=Object.keys(e),o=a.indexOf("definitions");o>0&&a.splice(0,0,a.splice(o,1)[0]),a.forEach(function(a){var o=Pointer.join(r,a),u=Pointer.join(t,a),h=e[a];$Ref.is$Ref(h)?n.some(function(r){return r.parent===e&&r.key===a})||inventory$Ref(e,a,r,u,n,i,f):crawl(h,o,u,n,i,f)})}}function inventory$Ref(e,r,t,n,i,f,a){var o=e[r],u=url.resolve(t,o.$ref),h=f._resolve(u,a),l=Pointer.parse(n).length,s=url.stripHash(h.path),c=url.getHash(h.path),p=s!==f._root$Ref.path,$=$Ref.isExtended$Ref(o);i.push({$ref:o,parent:e,key:r,pathFromRoot:n,depth:l,file:s,hash:c,value:h.value,circular:h.circular,extended:$,external:p}),crawl(h.value,h.path,n,i,f,a)}function remap(e){e.sort(function(e,r){return e.file!==r.file?e.file<r.file?-1:1:e.hash!==r.hash?e.hash<r.hash?-1:1:e.circular!==r.circular?e.circular?-1:1:e.extended!==r.extended?e.extended?1:-1:e.depth!==r.depth?e.depth-r.depth:r.pathFromRoot.lastIndexOf("/definitions")-e.pathFromRoot.lastIndexOf("/definitions")});var r,t,n;e.forEach(function(e){debug('Re-mapping $ref pointer "%s" at %s',e.$ref.$ref,e.pathFromRoot),e.external?e.file!==r||0!==e.hash.indexOf(t)?(r=e.file,t=e.hash,n=e.pathFromRoot,e.$ref=e.parent[e.key]=$Ref.dereference(e.$ref,e.value),e.circular&&(e.$ref.$ref=e.pathFromRoot)):e.$ref.$ref=Pointer.join(n,Pointer.parse(e.hash)):e.$ref.$ref=e.hash,debug("    new value: %s",e.$ref&&e.$ref.$ref?e.$ref.$ref:"[object Object]")})}var $Ref=require("./ref"),Pointer=require("./pointer"),debug=require("./util/debug"),url=require("./util/url");module.exports=bundle;

},{"./pointer":10,"./ref":11,"./util/debug":16,"./util/url":19}],2:[function(require,module,exports){
"use strict";function dereference(e,r){debug("Dereferencing $ref pointers in %s",e.$refs._root$Ref.path),e.$refs.circular=!1,crawl(e.schema,e.$refs._root$Ref.path,"#",[],e.$refs,r)}function crawl(e,r,n,f,c,u){var i=!1;return e&&"object"==typeof e&&(f.push(e),Object.keys(e).forEach(function(o){var a=Pointer.join(r,o),t=Pointer.join(n,o),l=e[o],d=!1;if($Ref.isAllowed$Ref(l,u)){var s=dereference$Ref(l,a,t,f,c,u);d=s.circular,e[o]=s.value}else d=-1===f.indexOf(l)?crawl(l,a,t,f,c,u):foundCircularReference(a,c,u);i=i||d}),f.pop()),i}function dereference$Ref(e,r,n,f,c,u){debug('Dereferencing $ref pointer "%s" at %s',e.$ref,r);var i=url.resolve(r,e.$ref),o=c._resolve(i,u),a=o.circular,t=a||-1!==f.indexOf(o.value);t&&foundCircularReference(r,c,u);var l=$Ref.dereference(e,o.value);return t||(t=crawl(l,o.path,n,f,c,u)),t&&!a&&"ignore"===u.dereference.circular&&(l=e),a&&(l.$ref=n),{circular:t,value:l}}function foundCircularReference(e,r,n){if(r.circular=!0,!n.dereference.circular)throw ono.reference("Circular $ref pointer found at %s",e);return!0}var $Ref=require("./ref"),Pointer=require("./pointer"),ono=require("ono"),debug=require("./util/debug"),url=require("./util/url");module.exports=dereference;
...
"use strict";function resolve(e,r){if(!r.resolve.external)return Promise.resolve();try{debug("Resolving $ref pointers in %s",e.$refs._root$Ref.path);var o=crawl(e.schema,e.$refs._root$Ref.path+"#",e.$refs,r);return Promise.all(o)}catch(s){return Promise.reject(s)}}function crawl(e,r,o,s){var t=[];return e&&"object"==typeof e&&Object.keys(e).forEach(function(i){var u=Pointer.join(r,i),n=e[i];if($Ref.isExternal$Ref(n)){var l=resolve$Ref(n,u,o,s);t.push(l)}else t=t.concat(crawl(n,u,o,s))}),t}function resolve$Ref(e,r,o,s){debug('Resolving $ref pointer "%s" at %s',e.$ref,r);var t=url.resolve(r,e.$ref),i=url.stripHash(t);return e=o._get$Ref(i),e?Promise.resolve(e.value):parse(t,o,s).then(function(e){debug("Resolving $ref pointers in %s",i);var r=crawl(e,i+"#",o,s);return Promise.all(r)})}var Promise=require("./util/promise"),$Ref=require("./ref"),Pointer=require("./pointer"),parse=require("./parse"),debug=require("./util/debug"),url=require("./util/url");module.exports=resolve;
