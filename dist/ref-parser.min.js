 ...
 * @license MIT
 */
"use strict";function $RefParser(){this.schema=null,this.$refs=new $Refs,this._basePath=""}var Promise=require("./promise"),Options=require("./options"),$Refs=require("./refs"),read=require("./read"),resolve=require("./resolve"),dereference=require("./dereference"),util=require("./util"),url=require("url"),ono=require("ono"),_cloneDeep=require("lodash/lang/cloneDeep"),_isFunction=require("lodash/lang/isFunction"),_isObject=require("lodash/lang/isObject"),_isPlainObject=require("lodash/lang/isPlainObject"),_isString=require("lodash/lang/isString");module.exports=$RefParser,$RefParser.parse=function(e,r,t){return(new $RefParser).parse(e,r,t)},$RefParser.prototype.parse=function(e,r,t){if(_isFunction(r)&&(t=r,r=void 0),e&&_isObject(e))return this.schema=_cloneDeep(e),this._basePath="",util.doCallback(t,null,this.schema),Promise.resolve(this.schema);if(!e||!_isString(e)){var i=ono("Expected a file path, URL, or object. Got %s",e);return util.doCallback(t,i,e),Promise.reject(i)}r=new Options(r);var n=this;return e=url.resolve(util.cwd(),e),this._basePath=util.stripHash(e),read(e,this,r).then(function(e){if(e.value&&_isPlainObject(e.value))return n.schema=e.value,util.doCallback(t,null,n.schema),n.schema;throw ono.syntax('"%s" is not a valid JSON Schema',n._basePath)})["catch"](function(e){return util.doCallback(t,e),Promise.reject(e)})},$RefParser.resolve=function(e,r,t){return(new $RefParser).resolve(e,r,t)},$RefParser.prototype.resolve=function(e,r,t){_isFunction(r)&&(t=r,r=void 0),r=new Options(r);var i=this;return this.parse(e,r).then(function(){return resolve(i,r)}).then(function(){return util.doCallback(t,null,i.$refs),i.$refs})["catch"](function(e){return util.doCallback(t,e,i.$refs),Promise.reject(e)})},$RefParser.dereference=function(e,r,t){return(new $RefParser).dereference(e,r,t)},$RefParser.prototype.dereference=function(e,r,t){_isFunction(r)&&(t=r,r=void 0),r=new Options(r);var i=this;return this.resolve(e,r).then(function(){return dereference(i,r),util.doCallback(t,null,i.schema),i.schema})["catch"](function(e){return util.doCallback(t,e,i.schema),Promise.reject(e)})};
...
"use strict";function ParserOptions(e){this.allow={json:!0,yaml:!0,empty:!0,unknown:!0},this.$refs={internal:!0,external:!0},this.cache={fs:60,http:300,https:300},_merge(this,e)}var _merge=require("lodash/object/merge");module.exports=ParserOptions;
...
"use strict";function $Ref(e){this.$refs=null,this.path=e,this.value=void 0,this.type="pending",this.expires=void 0}function parseJsonPointer(e){e="#"===e[0]?e.substr(1):e,e=e.split("/");for(var r=0;r<e.length;r++)e[r]=e[r].replace(/~1/g,"/").replace(/~0/g,"~");if(""!==e[0])throw ono.syntax('Invalid $ref pointer "%s". Pointers must begin with "#/"',e);return e.slice(1)}function resolveValue(e,r,t){if($Ref.isAllowed(e.value,t)){var i=url.resolve(e.path,e.value.$ref);i!==e.path&&(e.path=i,e.value=r.get(i))}return e}var util=require("./util"),url=require("url"),ono=require("ono"),_isObject=require("lodash/lang/isObject"),_isNumber=require("lodash/lang/isNumber"),_isString=require("lodash/lang/isString");module.exports=$Ref,$Ref.prototype.isExpired=function(){return!!(this.expires&&this.expires<=new Date)},$Ref.prototype.expire=function(){this.expires=new Date},$Ref.prototype.setValue=function(e,r){this.value=e;var t=r.cache[this.type];if(_isNumber(t)){var i=Date.now()+1e3*t;this.expires=new Date(i)}},$Ref.prototype.exists=function(e){try{return this.resolve(e),!0}catch(r){return!1}},$Ref.prototype.resolve=function(e,r){var t=util.getHash(e),i={path:e,value:this.value};if(!t)return i;for(var s=parseJsonPointer(t),n=0;n<s.length;n++){if(resolveValue(i,this.$refs,r),!(s[n]in i.value))throw ono.syntax('Error resolving $ref pointer "%s". \n"%s" not found.',e,t);i.value=i.value[s[n]]}return resolveValue(i,this.$refs,r)},$Ref.prototype.get=function(e,r){return this.resolve(e,r).value},$Ref.prototype.set=function(e,r,t){var i=util.getHash(e);if(!i)return void(this.value=r);var s=parseJsonPointer(i),n={path:e,value:this.value};try{for(var o=0;o<s.length-1;o++)resolveValue(n,this.$refs,t),s[o]in n.value?n.value=n.value[s[o]]:n.value=n.value[s[o]]={};resolveValue(n,this.$refs,t),n.value[s[s.length-1]]=r}catch(u){throw ono.syntax(u,'Error resolving $ref pointer "%s". \n"%s" not found.',e,i)}},$Ref.isAllowed=function(e,r){if(e&&_isObject(e)&&_isString(e.$ref))if("#"===e.$ref[0]){if(r.$refs.internal)return!0}else if(r.$refs.external)return!0};
...
},{"./_stream_duplex":114,"_process":108,"buffer":100,"core-util-is":119,"events":104,"inherits":106,"isarray":107,"process-nextick-args":120,"stream":126,"string_decoder/":136,"util":99}],117:[function(require,module,exports){
...
},{"./_stream_duplex":114,"buffer":100,"core-util-is":119,"events":104,"inherits":106,"process-nextick-args":120,"stream":126,"util-deprecate":121}],119:[function(require,module,exports){
(function (Buffer){
...
},{"./lib/_stream_duplex.js":114,"./lib/_stream_passthrough.js":115,"./lib/_stream_readable.js":116,"./lib/_stream_transform.js":117,"./lib/_stream_writable.js":118,"stream":126}],124:[function(require,module,exports){
